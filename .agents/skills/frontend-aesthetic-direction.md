...
Avoid the overused defaults — Inter, Roboto, Arial, Fraunces, bare system stacks. Pick with intent: a humanist sans (Söhne, Suisse), a modern serif (Tiempos, GT Sectra), an editorial classic (Tiempos Headline, Canela), a typewriter mono (JetBrains Mono, IBM Plex Mono), a geometric sans (Söhne Buch, Visby), depending on the mood. If a paid foundry may be out of reach, name the closest free alternative (e.g., Söhne for production, Albert Sans / Geist free).
