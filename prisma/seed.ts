  ...
  await prisma.setting.createMany({
    data: [
      ...
      },
      {
        ...
        type: 'text',
        value: JSON.stringify('دانلود اپلیکیشن پرسنلی خط ۱'),
        defaultValue: JSON.stringify('دانلود اپلیکیشن پرسنلی خط ۱'),
        category: 'download',
        isEnabled: true,
      },
      {
        ...
        type: 'text',
        value: JSON.stringify('نسخه‌های رسمی اندروید، آیفون و وب‌اپلیکیشن برای استفاده پرسنل و راهبران خط یک متروی تهران'),
        defaultValue: JSON.stringify('نسخه‌های رسمی اندروید، آیفون و وب‌اپلیکیشن برای استفاده پرسنل و راهبران خط یک متروی تهران'),
        category: 'download',
        isEnabled: true,
      },
      {
        ...
        category: 'download',
        options: JSON.stringify(['url', 'file']),
        isEnabled: true,
      },
      {
        ...
        type: 'text',
        value: JSON.stringify('https://metro.tehran.ir'),
        defaultValue: JSON.stringify('https://metro.tehran.ir'),
        category: 'download',
        isEnabled: true,
      },
      {
