...
## Corpus Check
- 1859 files · ~2,828,490 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 17280 nodes · 24845 edges · 1251 communities (1045 shown, 206 thin omitted)
...
- `POST()` --calls--> `getSessionUser()`  [INFERRED]
  src/app/api/content/categories/route.ts → src/server/rbac/guard.ts
...
## Communities (1251 total, 206 thin omitted)

### Community 0 - "API Routes & RBAC"
Cohesion: 0.15
Nodes (21): GET(), createCustomFieldDef(), deleteCustomFieldDef(), getCustomFieldDef(), listCustomFieldDefs(), updateCustomFieldDef(), CustomFieldDefInput, customFieldDefSchema (+13 more)

### Community 1 - "Service Layer & Validation"
Cohesion: 0.14
Nodes (25): DbShift, ResolvedShiftResponse, ShiftAssignmentDto, ShiftNoteDto, shiftsApi, ShiftTaskDto, ShiftTemplateDto, CycleShiftDetail (+17 more)

### Community 3 - "UI Components & Layout"
Cohesion: 0.05
Nodes (48): AppLayout(), metadata, RootLayout(), AppConfig, ConfigStore, useConfigStore, ActiveTrain, AnalyticsData (+40 more)
...
Cohesion: 0.02
Nodes (169): POST(), DELETE(), GET(), chunkText(), indexKnowledgeSource(), aiProviderSchema, GET(), POST() (+161 more)
...
Cohesion: 0.04
Nodes (118): AttendanceRecord, Device, INITIAL_DEVICES, Bulletin, FeedbackCategory, ChecklistItem, ChecklistRecord, LINE1_STATIONS (+110 more)
...
Cohesion: 0.07
Nodes (46): AMENDMENT_KINDS, AmendmentRule, RosterAmendmentDialogProps, STATUS_TYPES, FIELD_TYPES, FormField, FormTemplate, buildCompositeKey() (+38 more)
...
Cohesion: 0.12
Nodes (18): CHANNEL_KIND_META, ChatView(), PRIORITY_META, UserOption, addMessage(), ChannelKind, ChatMessage, ChatRoom (+10 more)
...
Cohesion: 0.03
Nodes (116): articleSchema, GET(), POST(), GET(), createSchema, DELETE(), GET(), PATCH() (+108 more)
...
Cohesion: 0.02
Nodes (108): AICachePage(), AIProvidersPage(), AmendmentRulesPage(), TripData, AttendancePage(), ACTION_LABELS, AuditActor, AuditLogEntry (+100 more)
...
Cohesion: 0.09
Nodes (36): CalendarConfig, createHoliday(), createOrgEvent(), DEFAULT_CALENDAR_CONFIG, deleteHoliday(), deleteOrgEvent(), getCalendarConfig(), getOrgEventSeenReport() (+28 more)
...
Cohesion: 0.05
Nodes (66): POST(), GET(), querySchema, GET(), PATCH(), createBulkNotifications(), createNotification(), getUnreadCount() (+58 more)
...
Cohesion: 0.03
Nodes (103): AdminAIPage(), NextDepartureHero(), NextDepartureHeroProps, TripAssignmentData, TripCard(), TripCardProps, TripDetailsSheetProps, CATEGORIES (+95 more)
...
Cohesion: 0.04
Nodes (90): CacheRecord, FAQ, Interaction, KnowledgeSource, layers, Persona, Provider, ReportData (+82 more)
...
Cohesion: 0.09
Nodes (29): POST(), exportUsersToExcel(), generateErrorReport(), ImportError, ImportResult, importUsersFromExcel(), listUsers(), PaginatedUsers (+21 more)
...
Cohesion: 0.02
Nodes (98): cosineSimilarity(), EmbeddingPipeline, getEmbedding(), AIGateway, Article, CRITICAL_KEYWORDS, POST(), rankArticles() (+90 more)
...
Cohesion: 0.05
Nodes (61): CreateActionTypeInput, createActionTypeSchema, CreateLogInput, CreateRoleInput, createRoleSchema, CreateSettingInput, createSettingSchema, CreateUserInput (+53 more)
...
Cohesion: 0.10
Nodes (30): cancelSchema, createMeetingSchema, GET(), PATCH(), POST(), cancelMeeting(), checkForMeetingShiftConflicts(), createMeetingRequest() (+22 more)
...
Cohesion: 0.07
Nodes (42): POST(), GET(), updatePlaylistSchema, updateScreenSchema, attemptPushDelivery(), attemptSmsDelivery(), isInQuietHours(), notifyEvent() (+34 more)
...
Cohesion: 0.06
Nodes (34): GeminiAdapter, adapters, AIProviderAdapter, AIResponse, getAdapter(), ProviderConfig, OpenAICompatibleAdapter, RouteOptions (+26 more)
...
Cohesion: 0.15
Nodes (19): GET(), getSession(), GET(), GET(), POST(), acknowledgeBulletin(), createBulletin(), getAllBulletins() (+11 more)

### Community 709 - "Community 709"
Cohesion: 0.04
Nodes (49): FaultLog, FaultReport, LOG_ACTION_LABELS, PRIORITY_CLASSES, PRIORITY_LABELS, TicketDetailPage(), UserRef, SHIFT_CLASSES (+41 more)
...
Cohesion: 0.23
Nodes (15): exportMonthToExcel(), SHIFT_FA, WEEKDAY_FA, CalendarInsights, computeStats(), findBridges(), getCalendarInsights(), HolidayBridge (+7 more)
...
Cohesion: 0.14
Nodes (15): audienceIncludes(), CalendarDay, CalendarEventEntry, CalendarHolidayEntry, CalendarMeetingEntry, CalendarOrgEventEntry, CalendarShiftEntry, DEFAULT_LAYERS (+7 more)
...
Cohesion: 0.27
Nodes (10): buildMyRosterDays(), buildSnapshot(), generateEtag(), MyRosterPayload, MyRosterTrip, precomputeOnPublish(), rebuildMyRosterDayForUsers(), SnapshotAssignment (+2 more)
...
Cohesion: 0.08
Nodes (34): POST(), AccessTokenPayload, getAccessSecret(), getRefreshSecret(), issueAccessToken(), issueRefreshToken(), RefreshTokenPayload, verifyAccessToken() (+26 more)
...
Cohesion: 0.23
Nodes (11): getFallbackHours(), resolveShiftLayer(), findAssignmentForUser(), getShiftForUserAndDate(), getShiftForUserAndDateFromDb(), MOCK_USERS_LIST, groupKeyFor(), calculateShiftForDate() (+3 more)
...
Cohesion: 0.10
Nodes (17): CalendarConfig, Holiday, HolidaysTab(), KIND_LABELS, OrgEvent, SeenReport, SHIFT_LABELS, ShiftHours (+9 more)
...
Cohesion: 0.09
Nodes (30): extractRequestContext(), RequestContext, writeAuditLog(), WriteAuditLogParams, getOrCreateIcsToken(), rotateIcsToken(), createPersonalEvent(), deletePersonalEvent() (+22 more)
...
Cohesion: 0.05
Nodes (55): approveInputSchema, configUpdateSchema, main(), seedFaultSubsystemData(), hasPermission(), GET(), POST(), POST() (+47 more)

### Community 1206 - "Community 1206"
Cohesion: 0.53
Nodes (5): getCalendarPreference(), updateCalendarPreference(), GET(), PATCH(), calendarPreferenceSchema
...
Cohesion: 0.06
Nodes (33): PrivateConfig, usePrivateConfig(), CtaTab(), FEATURE_ICONS, FeatureItem, FooterLinkItem, HeroQuote, ImagesTab() (+25 more)
...
Cohesion: 0.14
Nodes (19): PRIORITY_LABELS, commitCatalogImport(), commitFaultReportsImport(), commitTrainsImport(), ExcelImportError, ExcelImportPreview, exportToExcel(), parseDate() (+11 more)
...
- **Why does `cachedFetch()` connect `Community 875` to `Community 640`, `Community 832`, `Community 711`, `Community 778`, `Community 187`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `getSessionUser()` connect `Community 26` to `API Routes & RBAC`, `Tooling Configuration`, `Auth & Bulletin Routes`, `Community 1163`, `Community 527`, `Community 529`, `Community 19`, `Community 410`, `Community 28`, `Community 546`, `Community 803`, `Community 804`, `Community 558`, `Community 562`, `Community 1202`, `Community 693`, `Community 1205`, `Community 1206`, `Community 59`, `Community 705`, `Community 708`, `Community 326`, `Community 715`, `Community 1227`, `Community 852`, `Community 219`, `Community 220`, `Community 869`, `Community 372`, `Community 892`, `Community 895`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `authErrorResponse()` connect `Tooling Configuration` to `API Routes & RBAC`, `Auth & Bulletin Routes`, `Community 1163`, `Community 527`, `Community 529`, `Community 19`, `Community 26`, `Community 410`, `Community 28`, `Community 546`, `Community 803`, `Community 558`, `Community 562`, `Community 1202`, `Community 693`, `Community 1205`, `Community 1206`, `Community 59`, `Community 705`, `Community 708`, `Community 326`, `Community 715`, `Community 1227`, `Community 852`, `Community 219`, `Community 220`, `Community 869`, `Community 372`, `Community 892`, `Community 895`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
