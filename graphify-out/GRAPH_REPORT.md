# Graph Report - metro-line1-app  (2026-07-13)

## Corpus Check
- 1856 files · ~2,826,397 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 17264 nodes · 24822 edges · 1257 communities (1052 shown, 205 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 844 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c5e7a0c5`
...
1. `getSessionUser()` - 772 edges
2. `authErrorResponse()` - 726 edges
3. `prisma` - 290 edges
4. `requireRole()` - 249 edges
5. `cn()` - 230 edges
6. `requirePermission()` - 192 edges
7. `useAuthStore` - 185 edges
8. `toFa()` - 167 edges
9. `Button()` - 124 edges
10. `Card()` - 108 edges
...
- `AdminAIPage()` --calls--> `cn()`  [INFERRED]
  src/app/(app)/admin/ai/page.tsx → src/lib/utils.ts
- `KpiCard()` --calls--> `cn()`  [INFERRED]
  src/app/(app)/admin/analytics/page.tsx → src/lib/utils.ts
- `HealthCard()` --calls--> `cn()`  [INFERRED]
  src/app/(app)/admin/analytics/page.tsx → src/lib/utils.ts
- `KpiCard()` --calls--> `cn()`  [INFERRED]
  src/app/(app)/admin/tickets/page.tsx → src/lib/utils.ts

## Import Cycles
- 3-file cycle: `src/server/db-seed.ts -> src/server/modules/custom-fields/service.ts -> src/server/db.ts -> src/server/db-seed.ts`
- 3-file cycle: `src/server/db-seed.ts -> src/server/modules/landing/service.ts -> src/server/db.ts -> src/server/db-seed.ts`
...
## Communities (1257 total, 205 thin omitted)

### Community 0 - "API Routes & RBAC"
Cohesion: 0.07
Nodes (43): GET(), POST(), createCustomFieldDef(), deleteCustomFieldDef(), getCustomFieldDef(), listCustomFieldDefs(), updateCustomFieldDef(), exportUsersToExcel() (+35 more)

### Community 1 - "Service Layer & Validation"
Cohesion: 0.11
Nodes (33): findAssignmentForUser(), getShiftForUserAndDate(), getShiftForUserAndDateFromDb(), MOCK_USERS_LIST, groupKeyFor(), calculateShiftForDate(), findAssignment(), resolveShiftForUser() (+25 more)

### Community 3 - "UI Components & Layout"
Cohesion: 0.06
Nodes (35): metadata, RootLayout(), AppConfig, ConfigStore, useConfigStore, ActiveTrain, AnalyticsData, DashboardPage() (+27 more)

### Community 4 - "Pages & Client State"
Cohesion: 0.06
Nodes (44): CourseDetailView(), styles, DashboardView(), styles, ExamRunnerView(), styles, MonthlyReportScreen(), FormField (+36 more)

### Community 5 - "Build Config & Documentation"
Cohesion: 0.11
Nodes (21): AGENTS.md - Agent Instructions, CLAUDE.md - Claude Code Instructions, Tailwind CSS v4 CSS-First Config, Dark Mode as Default, DESIGN.md - Design System, Excel Import/Export with Error Reports, Image-Based Fault Ticketing, Jalali Calendar Integration (+13 more)
...
Cohesion: 0.02
Nodes (187): POST(), DELETE(), GET(), chunkText(), indexKnowledgeSource(), aiProviderSchema, GET(), POST() (+179 more)
...
Cohesion: 0.08
Nodes (40): acknowledgeMessage(), assertMember(), changeRoomSettings(), createGroupRoom(), getOrCreateDirectRoom(), getRoomReactions(), getRoomSettings(), listMessages() (+32 more)
...
Cohesion: 0.04
Nodes (110): emptyForm, Provider, AMENDMENT_KINDS, AmendmentRule, AttendanceRecord, Device, INITIAL_DEVICES, FeedbackCategory (+102 more)

### Community 13 - "Swap Request Actions"
Cohesion: 0.04
Nodes (46): dependencies, dayjs, expo, expo-blur, expo-document-picker, expo-file-system, expo-font, @expo-google-fonts/vazirmatn (+38 more)

### Community 14 - "Community 14"
Cohesion: 0.31
Nodes (8): buildIcsFeed(), icsDate(), icsDateTimeUtc(), icsEscape(), IcsEvent, renderEvent(), SHIFT_FA, GET()
...
Cohesion: 0.06
Nodes (28): metadata, AnnouncementBar(), AnnouncementBarProps, CtaData, CtaRow(), CtaRowProps, ICON_MAP, FallbackPoster() (+20 more)

### Community 17 - "Community 17"
Cohesion: 0.13
Nodes (14): ApproveUserInput, approveUserSchema, LoginInput, loginSchema, RefreshInput, refreshSchema, RegisterInput, registerSchema (+6 more)

### Community 18 - "Community 18"
Cohesion: 0.09
Nodes (24): PrivateConfig, usePrivateConfig(), CHANNEL_KIND_META, ChatView(), PRIORITY_META, UserOption, addMessage(), ChannelKind (+16 more)

### Community 19 - "Community 19"
Cohesion: 0.06
Nodes (46): ackSchema, POST(), GET(), GET(), addComment(), createPost(), deletePost(), emptyToNull() (+38 more)

### Community 20 - "Community 20"
Cohesion: 0.05
Nodes (39): dependencies, @base-ui/react, bcryptjs, class-variance-authority, clsx, dayjs, dayjs-jalali, dotenv (+31 more)
...
Cohesion: 0.11
Nodes (18): devDependencies, eslint, eslint-config-next, @opennextjs/cloudflare, prettier, prettier-plugin-tailwindcss, prisma, tailwindcss (+10 more)

### Community 25 - "Community 25"
Cohesion: 0.11
Nodes (17): 🔑 اکانت‌های دمو جهت تست, 🧪 دستورات کاربردی (Scripts), ⚡ راه‌اندازی سریع (Quick Start), 🚇 سامانه جامع سیر و حرکت خط ۱ مترو تهران (Tehran Metro Line 1 Platform), 🚀 ویژگی‌ها و امکانات کلیدی سامانه, 🛠️ پشته فناوری (Tech Stack), ۱. احراز هویت و سطوح دسترسی (RBAC), ۱. نصب وابستگی‌ها (+9 more)

### Community 26 - "Community 26"
Cohesion: 0.02
Nodes (142): articleSchema, GET(), POST(), createHoliday(), createOrgEvent(), DEFAULT_CALENDAR_CONFIG, deleteHoliday(), deleteOrgEvent() (+134 more)
...
Cohesion: 0.06
Nodes (31): Badge / Status chip, Brand & Style, Button variants, Colors, Components (خلاصهٔ بصری), DataTable (دفتر تلفن، تیکت، کاربران — فقط دسکتاپ), Elevation & Depth, FileDrop (excel / roster / ticket photo) (+23 more)
...
Cohesion: 0.02
Nodes (100): AICachePage(), AIProvidersPage(), AmendmentRulesPage(), TripData, AppLayout(), AttendancePage(), ACTION_LABELS, AuditActor (+92 more)
...
Cohesion: 0.06
Nodes (56): calendarApi, CalendarPage(), CalendarState, useCalendarStore, CalendarDay, CalendarEventEntry, CalendarHolidayEntry, CalendarInsights (+48 more)
...
Cohesion: 0.05
Nodes (40): 1.1 Install JetBrains Mono font, 1.2 Expand design tokens in `src/app/globals.css`, 1.3 Typography scale tokens, 1.4 Animation keyframes, 2.1 `SystemHealthPips` component, 2.2 `TopAppBar` component, 2.3 `MobileBottomNav` component, 2.4 `DataTable` enhancements (+32 more)

### Community 39 - "Community 39"
Cohesion: 0.05
Nodes (40): 1.1 Install dependencies, 1.2 Create `wrangler.toml`, 1.3 Create `.dev.vars`, 1.4 Update `package.json` scripts, 2.1 Update `src/server/db.ts`, 2.2 Update `prisma/schema.prisma`, 2.3 Turso setup commands, 3.1 Create `src/server/storage/r2.ts` (+32 more)

### Community 45 - "Community 45"
Cohesion: 0.11
Nodes (26): approveInputSchema, POST(), POST(), GET(), POST(), POST(), GET(), POST() (+18 more)

### Community 51 - "Community 51"
Cohesion: 0.05
Nodes (21): Tests for shadcn_add.py, Test adding components without shadcn config., Test adding components that are already installed., Test adding components with overwrite flag., Test adding components in dry run mode., Test ShadcnInstaller class., Test component addition with subprocess error., Test component addition when npx is not found. (+13 more)
...
Cohesion: 0.09
Nodes (24): GET(), defaultMatrix, GET(), PATCH(), GET(), GET(), POST(), createSchema (+16 more)
...
Cohesion: 0.04
Nodes (84): POST(), GET(), querySchema, GET(), fuzzyMatchScore(), jalaliToDate(), normalizeFarsiString(), GET() (+76 more)
...
Cohesion: 0.03
Nodes (62): ACTION_LABELS, AnalyticsData, AuditLog, ENTITY_LABELS, HealthCard(), KpiCard(), PRIORITY_COLORS, PRIORITY_LABELS (+54 more)

### Community 62 - "Community 62"
Cohesion: 0.03
Nodes (106): NextDepartureHero(), NextDepartureHeroProps, TripAssignmentData, TripCard(), TripCardProps, TripDetailsSheetProps, CATEGORIES, CustomFieldDef (+98 more)

### Community 63 - "Community 63"
Cohesion: 0.05
Nodes (36): AI search visibility (emerging), Article, Breadcrumbs, Crawlability, Critical, FAQ, Font sizes, Heading structure (+28 more)
...
Cohesion: 0.06
Nodes (34): Metro Line 1 Crew Management System — Project Proposal, طرح پیشنهادی: سیستم جامع مدیریت پرسنل خط ۱ مترو تهران, فاز ۱ (تکمیل‌شده), فاز ۱: هسته عملیاتی ✅ تکمیل‌شده, فاز ۲: ارتباطات و تعامل (پیشنهادی), فاز ۲-۴ (پیشنهادی), فاز ۳: تحلیل داده و هوشمندسازی (پیشنهادی), فاز ۴: استقرار و توسعه سازمانی (پیشنهادی) (+26 more)
...
Cohesion: 0.06
Nodes (32): امنیت, اولویت‌بندی اجرا, برنامه توسعه حرفه‌ای — سوپر اپ خط ۱ مetro تهران, خلاصه وضعیت فعلی, عملکرد, فاز ۳: بهبود و تکمیل وب‌اپ (هفته ۱–۴), فاز ۴: ماژول‌های جدید سازمانی (هفته ۵–۸), فاز ۵: هوشمندسازی و ویژگی‌های پیشرفته (هفته ۹–۱۲) (+24 more)

### Community 91 - "Community 91"
Cohesion: 0.06
Nodes (31): Avoid layout thrashing, Cache-Control headers, Caching strategy, Critical rendering path, Debounce expensive operations, Facade pattern, Font optimization, Format selection (+23 more)
...
Cohesion: 0.07
Nodes (29): acceptance-testing, classes, Clean Code Skill - Creation Progress, coding-practices, collaboration, comments, commitment, error-handling (+21 more)
...
Cohesion: 0.07
Nodes (29): 6.2 Content Publishing Workflow (چرخه انتشار محتوا), 6.3 Mandatory Content (محتوای اجباری), 6.4 Content Recommendation Engine (موتور پیشنهاد محتوا), 6.5 Professional Knowledge Base (دانشنامه حرفه‌ای), A. Mandatory Read Report (گزارش افراد مشاهده‌نکرده), Admin Editor — `src/app/(app)/admin/content/page.tsx`, Admin Knowledge Editor — `src/app/(app)/admin/knowledge/page.tsx`, API Changes — `src/app/api/posts/[id]/route.ts` (+21 more)
...
Cohesion: 0.07
Nodes (40): AppContent(), AttendanceRecord, AttendanceScreen(), METRO_STATIONS, MetroStation, ChatScreen(), ChecklistsScreen(), s (+32 more)

### Community 135 - "Community 135"
Cohesion: 0.05
Nodes (37): metadata, RosterBoardClient(), calculateLeftPosition(), calculateWidth(), OccTimeline(), OccTimelineProps, timeToMinutes(), Trip (+29 more)
...
Cohesion: 0.18
Nodes (15): lg, sm, $type, $value, $type, $value, shadow, lg (+7 more)
...
Cohesion: 0.08
Nodes (25): 10. Commented-Out Code, 11. Nonlocal Information, 12. Too Much Information, 1. Legal Comments, 1. Mumbling, 2. Explanation of Intent, 2. Redundant Comments, 3. Clarification (+17 more)
...
Cohesion: 0.08
Nodes (25): تأیید نهایی, ترتیب اجرا, فاز ۱: بحرانی (امنیت + دیتابیس), فاز ۲: حذف داده‌های Mock, فاز ۳: کیفیت کد, فاز ۴: توسعه موبایل, نقشه راه توسعه — Metro Line 1 App, ۱.۱ مهاجرت SQLite → PostgreSQL (+17 more)
...
Cohesion: 0.08
Nodes (24): Acceptable Feature Envy, After, Bad Example, Bad Example, Bad Example, Bad Example, Bad Example, Bad Example (+16 more)
...
Cohesion: 0.08
Nodes (24): بخش ۱: اصلاحات فوری (خطاها و مشکلات ساختاری), بخش ۲: اصلاحات ساختاری معماری, بخش ۳: اصلاحات RTL, بخش ۴: کامپوننت‌های UI_missing, بخش ۵: اصلاحات Backend, بخش ۶: اعتبارسنجی و تست, بررسی نهایی, برنامه تکمیل پروژه — باقیمانده‌ها و اصلاحات (+16 more)
...
Cohesion: 0.08
Nodes (23): CLS: Cumulative Layout Shift, CLS debugging, CLS optimization checklist, Common CLS causes, Common INP issues, Common LCP issues, Core Web Vitals optimization, Field data (real users) (+15 more)
...
Cohesion: 0.06
Nodes (49): d1, d2, CalendarScreen(), JALALI_MONTHS, SHIFT_MAPPING, LeaveReportScreen(), EVT_ORG, EVT_PERSONAL (+41 more)

### Community 188 - "Community 188"
Cohesion: 0.06
Nodes (32): الزامات ایمنی, امنیت آفلاین, حالت جلوگیری از خطای انسانی, قابلیت‌ها, نمونه پاسخ استاندارد AI, نکته امنیتی, نکته مهم, پیشنهادهای حرفه‌ای (+24 more)

### Community 189 - "Community 189"
Cohesion: 0.08
Nodes (23): 0. Design mandate for the agent, 10. Do / Don't, 1. Brand & principles, 2.1 Color (light mode), 2.2 Color (dark mode), 2.3 Typography (Vazirmatn variable), 2.4 Radius / shadow / motion, 2.5 Implementation (+15 more)
...
Cohesion: 0.09
Nodes (21): By Code Element, By Problem - Professional, By Problem/Symptom, By Situation - Communication, By Situation - Daily Work, By Situation - Team & Career, By Task - Code Review, By Task - Refactoring (+13 more)

### Community 205 - "Community 205"
Cohesion: 0.09
Nodes (21): After, After, After, Bad Examples, Before, Before, Before (with frustration comment), Changes Made (+13 more)
...
Cohesion: 0.40
Nodes (3): fixTextIfReversed(), main(), { PDFParse }
...
Cohesion: 0.07
Nodes (34): POST(), createFormSubmission(), evaluateFormula(), executeWorkflowAction(), validateSubmissionData(), POST(), GET(), GET() (+26 more)

### Community 220 - "Community 220"
Cohesion: 0.24
Nodes (13): createArticle(), createFAQ(), deleteArticle(), getArticleBySlug(), KnowledgeArticleData, KnowledgeFAQData, listArticles(), listFAQs() (+5 more)

### Community 221 - "Community 221"
Cohesion: 0.04
Nodes (107): CacheRecord, AdminAIPage(), FAQ, Interaction, KnowledgeSource, layers, Persona, Provider (+99 more)

### Community 222 - "Community 222"
Cohesion: 0.08
Nodes (24): سناریو ۱ — «رضایی کجاست؟», سناریو ۲ — فیلتر میانه‌روز, سناریو ۳ — انتشار شب و ارسال خودکار, سناریو ۴ — راهبر با دستکش, سناریو ۵ — اصلاحیه هدفمند, 🎨 طرح UI/UX لوحه اعزام روزانه — وب و موبایل, ۱) جهت‌گیری طراحی, ۲) جستجو و فیلتر همه‌چیز (Universal Search & Filter) (+16 more)
...
Cohesion: 0.10
Nodes (19): 10. Use Proper Indentation, 11. Never Collapse Short Statements, 12. Agree on Team Standards, 1. Keep Files Small, 2. Follow the Newspaper Metaphor, 3. Separate Concepts with Blank Lines, 4. Keep Related Code Dense, 5. Minimize Vertical Distance (+11 more)

### Community 229 - "Community 229"
Cohesion: 0.10
Nodes (19): 10. Practice Deliberately, 11. Collaborate and Teach, 12. Know Your Domain, 13. Identify with Employer/Customer, 14. Practice Humility, 1. Do No Harm to Function, 2. Do No Harm to Structure, 3. QA Should Find Nothing (+11 more)

### Community 230 - "Community 230"
Cohesion: 0.10
Nodes (19): Bug Fix Workflow, Debugging Tips, Exit Criteria, Prerequisites, Quick Checklist, Red Flags, Step 1: Understand the Bug, Step 2: Reproduce the Bug (+11 more)
...
Cohesion: 0.24
Nodes (9): ActiveModal, PLATE_LETTERS, ProfileScreen(), ROLE_LABEL, { width: SCREEN_W, height: SCREEN_H }, pickAndUploadDocument(), pickAndUploadImage(), uploadAsset() (+1 more)
...
Cohesion: 0.10
Nodes (19): 1a. Database: SQLite dev + PostgreSQL prod, 1b. Shared Zod Schemas (`src/lib/zod/`), 1c. `.env.example` Update, 2a. Remove `as any` Casts, 2b. Enforce AGENTS.md Hard Rules, 2c. API Response Format Consistency, 3a. Test Infrastructure, 3b. Critical Path Tests (+11 more)
...
Cohesion: 0.11
Nodes (18): Category Overview, Code Smell, Code Smells Knowledge, Comments (C1-C5), Common Misconceptions, Environment (E1-E2), Functions (F1-F4), General (G1-G36) (+10 more)

### Community 256 - "Community 256"
Cohesion: 0.11
Nodes (18): Accepting All Meeting Invites, Avoiding the Hard Task, Backing Out of Blind Alley, Bad Examples, Coding Without Focus, Declining with Professionalism, Escaping the Swamp Early, Facing the Hard Task (+10 more)
...
Cohesion: 0.11
Nodes (17): 10. Never Falsely Deliver, 11. Help Others and Accept Help, 12. Partition Worry Time, 1. Never Code When Impaired, 2. Avoid the Flow Zone, 3. Handle Interruptions Gracefully, 4. Seek Creative Input, 5. Minimize Debugging Time (+9 more)

### Community 275 - "Community 275"
Cohesion: 0.11
Nodes (17): 10. Don't Pun, 11. Add Meaningful Context, 12. Don't Add Gratuitous Context, 1. Use Intention-Revealing Names, 2. Avoid Disinformation, 3. Make Meaningful Distinctions, 4. Use Pronounceable Names, 5. Use Searchable Names (+9 more)

### Community 276 - "Community 276"
Cohesion: 0.11
Nodes (17): After Practice, Before Practice, Classic Kata Examples, Daily Warm-up (15 minutes), During Practice, Good Practice Habits, Kata Resources, Monthly Challenge (+9 more)
...
Cohesion: 0.12
Nodes (16): Buttons, Common ARIA patterns, Error states, Form fields, Level A (minimum), Level AA (standard), Level AAA (enhanced), Links (+8 more)
...
Cohesion: 0.12
Nodes (16): After, Bad Examples, Before, Changes Made, Collapsed One-Liners, Excessive Comments Breaking Density, Formatting Examples, Good Examples (+8 more)

### Community 290 - "Community 290"
Cohesion: 0.12
Nodes (16): Deadline Negotiation Workflow, Exit Criteria, Prerequisites, Quick Reference, Step 1: Gather Information, Step 2: Do Your Estimation, Step 3: Identify Options, Step 4: Have the Conversation (+8 more)
...
Cohesion: 0.12
Nodes (15): 10. Use Descriptive Names, 1. Keep Functions Small, 2. Do One Thing, 3. One Level of Abstraction, 4. Minimize Arguments, 5. No Flag Arguments, 6. No Side Effects, 7. Command Query Separation (+7 more)

### Community 302 - "Community 302"
Cohesion: 0.12
Nodes (15): After: Context Through Class, Bad Examples, Before: Variables Without Context, Clean Class Without Encodings, Disinformative Names, Encoded Names, Good Examples, Intention-Revealing Names (+7 more)

### Community 303 - "Community 303"
Cohesion: 0.12
Nodes (15): Blind Alleys, De-focusing Activities, Focus-Manna, Input for Output, Key Concepts, Meeting Cost, Messes (Bogs/Swamps), Overview (+7 more)

### Community 304 - "Community 304"
Cohesion: 0.12
Nodes (15): 10. Fear Messes More Than Blind Alleys, 1. Decline Meetings Without Clear Value, 2. Leave Meetings That Waste Your Time, 3. Require Agendas and Goals, 4. Keep Stand-ups Under 10 Minutes, 5. Limit Iteration Planning to 5% of Iteration Time, 6. Schedule Retrospectives Before Quitting Time, 7. Settle Arguments with Data, Not Force (+7 more)

### Community 305 - "Community 305"
Cohesion: 0.12
Nodes (15): Common Mistakes to Avoid, Estimation Workflow, Exit Criteria, Prerequisites, Quick Reference Card, Step 1: Clarify the Request, Step 2: Break Down the Task, Step 3: Apply PERT to Each Subtask (+7 more)

### Community 306 - "Community 306"
Cohesion: 0.12
Nodes (15): Avatar group hover, Card resize, Contents, CSS Transition Recipes, Custom properties, Error state shake, Icon swap, Menu dropdown (+7 more)
...
Cohesion: 0.06
Nodes (36): HomeStackScreen(), MainTabs(), RootStackParamList, Stack, Tab, AIAssistantScreen(), CITATION_DATABASE, FAQ_ITEMS (+28 more)

### Community 322 - "Community 322"
Cohesion: 0.08
Nodes (23): KPIهای آموزشی, KPIهای ارتباطی, KPIهای عملیاتی, KPIهای مدیریتی, MVP پیشنهادی, جمع‌بندی پیشنهادی, فاز ۱ — هسته ضروری, فاز ۲ — عملیات روزانه (+15 more)
...
Cohesion: 0.13
Nodes (14): Acceptance Testing Examples, After: Executable Specification, Bad Examples, Before: Ambiguous Manual Process, Changes Made, Gherkin Feature Specification, Good Examples, GUI Position-Based Test (+6 more)

### Community 334 - "Community 334"
Cohesion: 0.13
Nodes (14): Bad Scenarios, Coding Practices Examples, Good Scenarios, Key Patterns, The 3 AM Hero, The Block Breaker, The False Delivery, The Gracious Interruptee (+6 more)

### Community 335 - "Community 335"
Cohesion: 0.13
Nodes (14): After, Bad Examples, Before, Changes Made, Clean Exception-Based Code, Empty Collection Instead of Null, Error Codes Cluttering Logic, Error Handling Examples (+6 more)

### Community 336 - "Community 336"
Cohesion: 0.13
Nodes (14): Bad Examples, Communicating Uncertainty, Declining a Commitment Request, Estimation Examples, Estimation Technique Examples, Flying Fingers, Good Examples, Key Takeaways (+6 more)

### Community 337 - "Community 337"
Cohesion: 0.13
Nodes (14): 1. Never Confuse Estimates with Commitments, 2. Never Make Implied Commitments, 3. Provide Trivariate Estimates (PERT), 4. Use Team Estimation Techniques, 5. Break Large Tasks into Smaller Ones, Combining Multiple Task Estimates, Communicating Estimates, Core Rules (+6 more)

### Community 338 - "Community 338"
Cohesion: 0.13
Nodes (14): Coding Without Domain Knowledge, Continuous Learning in Practice, Contrasts Summary, Fearless Refactoring, Humble Response to Failure, Letting Employer Own Your Career, Mentoring a Junior Developer, Professional Behavior Scenarios (+6 more)

### Community 339 - "Community 339"
Cohesion: 0.13
Nodes (14): Avoiding Confrontation (Both Parties Fail), Bad Examples, Contrast: Same Situation, Different Approaches, Good Examples, High Stakes Confrontation, Key Patterns, Manager Commits Team Without Input, Passive Acceptance (No Advocacy) (+6 more)

### Community 340 - "Community 340"
Cohesion: 0.13
Nodes (14): After, Bad Examples, Before, Changes Made, Clean Test with Domain Language, Compact State Representation, Good Examples, Hard-to-Read State Assertions (+6 more)

### Community 341 - "Community 341"
Cohesion: 0.13
Nodes (14): Exit Criteria, New Feature Workflow, Prerequisites, Quick Checklist, Step 1: Understand Requirements, Step 2: Plan the Approach, Step 3: Write Acceptance Test(s), Step 4: Build with TDD (+6 more)

### Community 342 - "Community 342"
Cohesion: 0.13
Nodes (14): Exit Criteria, Prerequisites, Quick Reference, Step 1: Think, Step 2: RED - Write a Failing Test, Step 3: GREEN - Make It Pass, Step 4: REFACTOR - Clean Up, Step 5: Repeat (+6 more)

### Community 343 - "Community 343"
Cohesion: 0.13
Nodes (14): Exit Criteria, Prerequisites, Step 1: Understand What to Test, Step 2: Define Unit Test Coverage, Step 3: Define Component Test Coverage, Step 4: Define Integration Test Coverage, Step 5: Define E2E/System Test Coverage, Step 6: Plan Manual/Exploratory Testing (+6 more)

### Community 344 - "Community 344"
Cohesion: 0.13
Nodes (14): Accessibility, Anti-patterns, Core rules, Easing defaults, Motion design principles, Performance, Reference files, Related skills (+6 more)
...
Cohesion: 0.07
Nodes (30): bufferToEmbedding(), calculateSlaDueTime(), detectRecurrence(), executeWorkflowTransition(), matchFaultCode(), POST(), CreateFaultCategoryInput, createFaultCategorySchema (+22 more)
...
Cohesion: 0.14
Nodes (13): 1. Always Automate Acceptance Tests, 2. Define "Done" With Passing Tests, 3. Write Tests Late, But Before Implementation, 4. Separate Test Authors From Implementers, 5. Never Be Passive-Aggressive With Tests, 6. Test Through APIs, Not GUIs, 7. Keep CI Tests Always Passing, Acceptance Testing Rules (+5 more)

### Community 385 - "Community 385"
Cohesion: 0.14
Nodes (13): After: Family of Single-Purpose Classes, Bad Examples, Before: Monolithic SQL Class, Changes Made, Class Violating Open-Closed Principle, Classes Examples, Concrete Dependency Making Testing Hard, Dependency Injection for Testability (+5 more)

### Community 386 - "Community 386"
Cohesion: 0.14
Nodes (13): Class Organization, Classes Knowledge, Cohesion, Common Misconceptions, Dependency Inversion Principle (DIP), Encapsulation, How It Relates To, Key Concepts (+5 more)

### Community 387 - "Community 387"
Cohesion: 0.14
Nodes (13): After, Bad Examples, Before, Changes Made, Command Query Separation, Functions Examples, Good Examples, Hidden Side Effect (+5 more)

### Community 388 - "Community 388"
Cohesion: 0.14
Nodes (13): Certainty, Common Misconceptions, Courage, Defect Injection Rate, Design Benefits, Documentation, How It Relates To, Key Concepts (+5 more)

### Community 389 - "Community 389"
Cohesion: 0.14
Nodes (13): 1. First Law: No Production Code Without a Failing Test, 2. Second Law: Minimal Failing Test, 3. Third Law: Minimal Production Code, Core Rules, Exceptions, Guidelines, Quick Reference, Rapid Cycle Time (+5 more)

### Community 390 - "Community 390"
Cohesion: 0.14
Nodes (13): Clean Code, Code Quality, Critical: Reference-First Approach, Guidelines, Key Principles (Summary Only — Always Load Full References), Part 1: Code Quality (Clean Code book), Part 2: Professional Practices (Clean Coder book), Professional Practices (+5 more)
...
Cohesion: 0.08
Nodes (29): POST(), GET(), POST(), authenticate(), GET(), POST(), calculatePeriodScoresAndNormalize(), COMPETENCY_IDS (+21 more)
...
Cohesion: 0.15
Nodes (12): Acceptance Testing Knowledge, Acceptance Tests as Communication, Common Misconceptions, How It Relates To, Key Concepts, Late Ambiguity, Overview, Premature Precision (+4 more)

### Community 420 - "Community 420"
Cohesion: 0.15
Nodes (12): Coding Practices Knowledge, Common Misconceptions, Debugging Mindset, How It Relates To, Key Concepts, Overview, Pacing, Preparedness (+4 more)

### Community 421 - "Community 421"
Cohesion: 0.15
Nodes (12): Bad Response Examples, Breaking Dependencies into Controllable Actions, Commitment Examples, Commitment Language, Honest Uncertainty, Negotiating a Real Commitment, Non-Commitment Language, Saying No Professionally (+4 more)

### Community 422 - "Community 422"
Cohesion: 0.15
Nodes (12): 1. Use Exceptions, Not Return Codes, 2. Write Try-Catch-Finally First, 3. Provide Context with Exceptions, 4. Define Exceptions by Caller's Needs, 5. Define the Normal Flow, 6. Don't Return Null, 7. Don't Pass Null, Core Rules (+4 more)

### Community 423 - "Community 423"
Cohesion: 0.15
Nodes (12): An Estimate is a Distribution, Common Misconceptions, Estimate vs Commitment, Estimation Knowledge, How It Relates To, Implied Commitments, Key Concepts, Law of Large Numbers (+4 more)

### Community 424 - "Community 424"
Cohesion: 0.15
Nodes (12): 1. Practice on Your Own Time, 2. Use Different Languages and Platforms, 3. Know Multiple Kata, 4. Practice Until Automatic, 5. Contribute to Open Source, Core Rules, Exceptions, Guidelines (+4 more)

### Community 425 - "Community 425"
Cohesion: 0.15
Nodes (12): 1. Never Change Your Behavior in a Crisis, 2. Never Commit to Deadlines You Can't Meet, 3. Stay Clean to Go Fast, 4. Don't Panic When Pressure Hits, 5. Communicate Early and Often, 6. Rely More on Disciplines Under Pressure, 7. Get Help Through Pairing, Core Rules (+4 more)

### Community 426 - "Community 426"
Cohesion: 0.15
Nodes (12): 1. Say No to Impossible Commitments, 2. Never Promise to "Try", 3. Avoid Passive Aggression, 4. Defend Your Estimates Under Pressure, 5. Negotiate Toward the Best Outcome, Core Rules, Exceptions, Guidelines (+4 more)

### Community 427 - "Community 427"
Cohesion: 0.15
Nodes (12): Clean Tests, Common Misconceptions, Domain-Specific Testing Language (DSL), Dual Standard, How It Relates To, Key Concepts, Overview, Quick Reference (+4 more)

### Community 428 - "Community 428"
Cohesion: 0.15
Nodes (12): 1. Three Laws of TDD, 2. Keep Tests Clean, 3. Prioritize Readability, 4. Follow BUILD-OPERATE-CHECK Pattern, 5. Single Concept per Test, 6. Minimize Asserts per Concept, 7. F.I.R.S.T. Principles, Core Rules (+4 more)

### Community 429 - "Community 429"
Cohesion: 0.15
Nodes (12): ANALYSIS PROCESS, Comments, Error Handling, FRONTMATTER UPDATE, Functions, Naming, NEXT STEP, PRESENT FINDINGS (+4 more)

### Community 430 - "Community 430"
Cohesion: 0.15
Nodes (12): Check Completion, DECISION, EVALUATION, FRONTMATTER UPDATE, If complete:, If Done (smell eliminated), If looping:, If NOT Done (smell remains) (+4 more)
...
Cohesion: 0.15
Nodes (12): Brand & Style, Buttons, Colors, Components, Data Tables, Elevation & Depth, Layout & Spacing, Persian Calendar & Inputs (+4 more)
...
Cohesion: 0.17
Nodes (11): 1. Classes Should Be Small (Measured by Responsibilities), 2. Follow the Single Responsibility Principle (SRP), 3. Maintain High Cohesion, 4. Organize for Change (Open-Closed Principle), 5. Isolate from Change (Dependency Inversion), 6. Follow Standard Class Organization, Classes Rules, Core Rules (+3 more)

### Community 469 - "Community 469"
Cohesion: 0.17
Nodes (11): Bad Scenarios, Collaboration Examples, Collective Ownership in Practice, Comparison Table, Effective Pairing, Good Scenarios, Key Takeaways, The Collaborative Workspace (+3 more)

### Community 470 - "Community 470"
Cohesion: 0.17
Nodes (11): Cerebellums (Working Together), Collaboration Knowledge, Collective Ownership, Common Misconceptions, How It Relates To, Key Concepts, Overview, Owned Code (+3 more)

### Community 471 - "Community 471"
Cohesion: 0.17
Nodes (11): Code as Truth, Comment Decay, Comments as Failure, Comments Knowledge, Common Misconceptions, How It Relates To, Key Concepts, Overview (+3 more)

### Community 472 - "Community 472"
Cohesion: 0.17
Nodes (11): Commitment Knowledge, Common Misconceptions, Key Concepts, Language of Commitment, Overview, Quick Reference, Terminology, The Say/Mean/Do Framework (+3 more)

### Community 473 - "Community 473"
Cohesion: 0.17
Nodes (11): 1. Use "I will... by..." Language, 2. Only Commit to What You Control, 3. Raise Red Flags Immediately, 4. Give Binary Responses, 5. Maintain Discipline Under Pressure, Commitment Rules, Core Rules, Exceptions (+3 more)

### Community 474 - "Community 474"
Cohesion: 0.17
Nodes (11): Common Misconceptions, Error Handling Knowledge, Exception-Based Error Handling, How It Relates To, Key Concepts, Normal Flow Pattern, Overview, Quick Reference (+3 more)

### Community 475 - "Community 475"
Cohesion: 0.17
Nodes (11): Common Misconceptions, Formatting Knowledge, Horizontal Formatting, How It Relates To, Key Concepts, Overview, Quick Reference, Terminology (+3 more)

### Community 476 - "Community 476"
Cohesion: 0.17
Nodes (11): Abstraction Levels, Common Misconceptions, Do One Thing, Functions Knowledge, How It Relates To, Key Concepts, Overview, Quick Reference (+3 more)

### Community 477 - "Community 477"
Cohesion: 0.17
Nodes (11): Common Misconceptions, How It Relates To, Intention-Revealing Names, Key Concepts, Meaningful Distinctions, Mental Mapping, Naming Knowledge, Overview (+3 more)

### Community 478 - "Community 478"
Cohesion: 0.17
Nodes (11): Common Misconceptions, How It Relates To, Kata, Key Concepts, Overview, Practicing Knowledge, Quick Reference, Randori (+3 more)

### Community 479 - "Community 479"
Cohesion: 0.17
Nodes (11): Commitment Management, Contrasting Approaches, Discipline Abandonment, Key Insight, Pressure Examples, Pressure Response Protocol, Professional Behavior Scenarios, The Calm Surgeon (+3 more)

### Community 480 - "Community 480"
Cohesion: 0.17
Nodes (11): Adversarial Roles, Being a Team Player, Common Misconceptions, High Stakes Situations, How It Relates To, Key Concepts, Overview, Quick Reference (+3 more)

### Community 481 - "Community 481"
Cohesion: 0.17
Nodes (11): After Refactoring, Before Refactoring, Cycle 1: Empty Stack, Cycle 2: Push Makes Non-Empty, Cycle 3: Pop Returns Pushed Item, Cycle 4: LIFO Order, Example: Building a Stack, Quick Reference (+3 more)

### Community 482 - "Community 482"
Cohesion: 0.17
Nodes (11): 1. Ask the User, 2. Check for Existing Report, 3. Fresh Workflow Setup, 4. Understand Context, 5. Append Context to Report, EXECUTION, FRONTMATTER UPDATE, NEXT STEP (+3 more)

### Community 483 - "Community 483"
Cohesion: 0.17
Nodes (11): 1. Gather All Findings, 2. Prioritize Issues, 3. Format Feedback, 4. Write Summary, COMPILATION PROCESS, FRONTMATTER UPDATE, PRESENT TO USER, REFERENCE LOADING (+3 more)

### Community 484 - "Community 484"
Cohesion: 0.17
Nodes (11): 1. Ask the User, 2. Check for Existing Report, 3. Fresh Workflow Setup, 4. Understand the Context, 5. Append Context to Report, EXECUTION, FRONTMATTER UPDATE, NEXT STEP (+3 more)

### Community 485 - "Community 485"
Cohesion: 0.17
Nodes (11): 1. Gather All Findings, 2. Categorize Feedback, 3. Format Each Item, 4. Include Praise, COMPILATION PROCESS, FRONTMATTER UPDATE, NEXT STEP, PRESENT FINDINGS (+3 more)

### Community 486 - "Community 486"
Cohesion: 0.17
Nodes (11): 1. Write Final Decision, Approve when:, Comment when:, COMPILATION, DECISION CRITERIA, FRONTMATTER UPDATE, PRESENT TO USER, Request Changes when: (+3 more)

### Community 487 - "Community 487"
Cohesion: 0.17
Nodes (11): 1. Ask the User, 2. Check for Existing Log, 3. Fresh Workflow Setup, 4. Verify Tests Pass, 5. Append to Log, EXECUTION, FRONTMATTER UPDATE, NEXT STEP (+3 more)

### Community 488 - "Community 488"
Cohesion: 0.17
Nodes (11): 1. Should this animate at all?, 2. What is the purpose?, 3. What easing should it use?, 4. How fast should it be?, Animation Decision Framework, Asymmetric timing, Asymmetric vs symmetric curves, Contents (+3 more)

### Community 489 - "Community 489"
Cohesion: 0.17
Nodes (11): Animation Review Format, Before/After/Why table, Component design principles, Contents, Debugging animations, Escalation triggers, Operating posture, Remedial preference hierarchy (+3 more)
...
Cohesion: 0.06
Nodes (51): CreateActionTypeInput, createActionTypeSchema, CreateLogInput, CreateRoleInput, createRoleSchema, CreateSettingInput, createSettingSchema, CreateUserInput (+43 more)
...
Cohesion: 0.11
Nodes (26): createFeedbackSchema, GET(), addFeedbackMessage(), createFeedback(), createFeedbackCategory(), deleteFeedbackCategory(), FeedbackData, getFeedbackByToken() (+18 more)
...
Cohesion: 0.35
Nodes (9): GET(), PATCH(), POST(), createPoll(), deactivatePoll(), getPollResults(), listActivePolls(), PollData (+1 more)
...
Cohesion: 0.07
Nodes (23): BaseModel, GraphDB, Generates embedding for text and stores it., Searches for top_k most similar chunks using cosine similarity., VectorDB, Any, Any, global_query() (+15 more)
...
Cohesion: 0.18
Nodes (10): 1. Practice Collective Code Ownership, 2. Do Not Build Walls Around Code, 3. Pair with Other Programmers, 4. Work Together Physically, 5. Review All Code, Collaboration Rules, Core Rules, Exceptions (+2 more)

### Community 535 - "Community 535"
Cohesion: 0.18
Nodes (10): Avoiding Pressure, Common Misconceptions, Crisis Discipline, Handling Pressure, How It Relates To, Key Concepts, Overview, Pressure Knowledge (+2 more)

### Community 536 - "Community 536"
Cohesion: 0.18
Nodes (10): Common Misconceptions, Do No Harm, How It Relates To, Key Concepts, Overview, Professionalism Knowledge, Quick Reference, Responsibility and Accountability (+2 more)

### Community 537 - "Community 537"
Cohesion: 0.18
Nodes (10): Code Smells Reference, E1: Build Requires More Than One Step, E2: Tests Require More Than One Step, Environment (E1-E2), F1: Too Many Arguments, F2: Output Arguments, F3: Flag Arguments, F4: Dead Function (+2 more)

### Community 538 - "Community 538"
Cohesion: 0.18
Nodes (10): API Endpoint Test, Business Logic Test, Component Tests (Supertest), End-to-End User Flow, Integration Tests (Supertest + Database), Multi-Component Communication Test, Quick Reference, System Tests (Playwright) (+2 more)

### Community 539 - "Community 539"
Cohesion: 0.18
Nodes (10): Common Misconceptions, How It Relates To, Key Concepts, Overview, QA as Part of the Team, QA Should Find Nothing, Quick Reference, Terminology (+2 more)

### Community 540 - "Community 540"
Cohesion: 0.18
Nodes (10): 1. Unit Tests, 2. Component Tests, 3. Integration Tests, 4. System Tests, 5. Manual Exploratory Tests, Core Rules, Exceptions, Guidelines (+2 more)

### Community 541 - "Community 541"
Cohesion: 0.18
Nodes (10): 1. Determine if Running is Needed, 2. Run Tests, 3. Manual Testing, 4. Record Results, EXECUTION, FRONTMATTER UPDATE, NEXT STEP, PRESENT FINDINGS (+2 more)
...
Cohesion: 0.04
Nodes (42): metadata, configUpdateSchema, PRIORITY_LABELS, exportToExcel(), main(), seedFaultSubsystemData(), hasPermission(), GET() (+34 more)
...
Cohesion: 0.44
Nodes (8): GET(), POST(), ChecklistRecordData, ChecklistTemplateData, createTemplate(), getUserChecklistHistory(), listTemplates(), submitChecklist()
...
Cohesion: 0.11
Nodes (18): سناریو ۱ — صبح راهبر (سرعت + آفلاین), سناریو ۲ — انتشار روز, سناریو ۳ — اصلاحیه ظهر (هدفمند، نه طوفان اعلان), سناریو ۴ — بررسی پس از رخداد, سناریو ۵ — گزارش ماهانه عدالت, 🚉 طرح جامع لوحه اعزام روزانه نسل بعد (Roster Platform v2), ۱) زیرساخت موجود (پایه‌ی قوی فعلی), ۱۰) UI (وب + موبایل — چکیده) (+10 more)

### Community 562 - "Community 562"
Cohesion: 0.04
Nodes (67): cancelSchema, GET(), updatePlaylistSchema, updateScreenSchema, createMeetingSchema, GET(), PATCH(), POST() (+59 more)
...
Cohesion: 0.20
Nodes (9): Data Fetching Patterns, generateMetadata, generateStaticParams (SSG), Next.js App Router — File Convention Reference, Route Segments, Server Component (Default), Special Files, With Params (Async in Next.js 16) (+1 more)
...
Cohesion: 0.20
Nodes (9): Arguments, Command Query Separation, Error Handling, Functions Checklist, Naming, Quick Reference, Red Flags, Single Responsibility (+1 more)

### Community 594 - "Community 594"
Cohesion: 0.20
Nodes (10): T1: Insufficient Tests, T2: Use a Coverage Tool, T3: Don't Skip Trivial Tests, T4: An Ignored Test Is a Question about an Ambiguity, T5: Test Boundary Conditions, T6: Exhaustively Test Near Bugs, T7: Patterns of Failure Are Revealing, T8: Test Coverage Patterns Can Be Revealing (+2 more)

### Community 595 - "Community 595"
Cohesion: 0.20
Nodes (9): ANALYSIS PROCESS, FRONTMATTER UPDATE, NEXT STEP, PRESENT FINDINGS, Questions to Answer, Red Flags, REFERENCE LOADING, Step 2: Review the Tests First (+1 more)

### Community 596 - "Community 596"
Cohesion: 0.20
Nodes (9): 1. Scan for Smells, 2. Confirm with User, ANALYSIS PROCESS, FRONTMATTER UPDATE, NEXT STEP, PRESENT FINDINGS, REFERENCE LOADING, Step 2: Identify the Smell (+1 more)

### Community 597 - "Community 597"
Cohesion: 0.20
Nodes (9): 1. Break Down the Refactoring, 2. Example Breakdown, 3. Common Refactoring Patterns, FRONTMATTER UPDATE, NEXT STEP, PLANNING PROCESS, PRESENT PLAN, Step 3: Plan Small Steps (+1 more)

### Community 598 - "Community 598"
Cohesion: 0.20
Nodes (9): Checklist, Common Refactorings, EXECUTION, FRONTMATTER UPDATE, NEXT STEP, PRESENT CHANGE, REFERENCE LOADING, Step 4: Make ONE Change (+1 more)

### Community 599 - "Community 599"
Cohesion: 0.20
Nodes (9): Compositing layers and will-change, Contents, CSS variables inheritance trap, CSS vs JS animations, Fix shaky 1px shifts, Motion transform ownership, Pause looping animations off-screen, Performance Deep Dive (+1 more)
...
Cohesion: 0.24
Nodes (9): GeminiAdapter, adapters, AIProviderAdapter, AIResponse, getAdapter(), ProviderConfig, OpenAICompatibleAdapter, AIGateway (+1 more)
...
Cohesion: 0.22
Nodes (8): 1. Read Existing Report, 2. Show Progress Summary, 3. Offer Options, 4. Route to Next Step, EXECUTION, NEXT STEP, Step 1b: Continue Previous Code Review, STEP GOAL

### Community 645 - "Community 645"
Cohesion: 0.22
Nodes (8): ANALYSIS PROCESS, FRONTMATTER UPDATE, NEXT STEP, PRESENT FINDINGS, Red Flags, REFERENCE LOADING, Step 2: Check Function Quality, STEP GOAL

### Community 646 - "Community 646"
Cohesion: 0.22
Nodes (8): ANALYSIS PROCESS, FRONTMATTER UPDATE, NEXT STEP, PRESENT FINDINGS, Red Flags, REFERENCE LOADING, Step 3: Check Naming, STEP GOAL

### Community 647 - "Community 647"
Cohesion: 0.22
Nodes (8): ANALYSIS PROCESS, FRONTMATTER UPDATE, NEXT STEP, PRESENT FINDINGS, Red Flags, REFERENCE LOADING, Step 4: Check Class/Module Design, STEP GOAL

### Community 648 - "Community 648"
Cohesion: 0.22
Nodes (8): ANALYSIS PROCESS, FRONTMATTER UPDATE, NEXT STEP, PRESENT FINDINGS, Red Flags, REFERENCE LOADING, Step 5: Check Error Handling, STEP GOAL

### Community 649 - "Community 649"
Cohesion: 0.22
Nodes (8): ANALYSIS PROCESS, FRONTMATTER UPDATE, NEXT STEP, PRESENT FINDINGS, Red Flags, REFERENCE LOADING, Step 6: Check Tests, STEP GOAL

### Community 650 - "Community 650"
Cohesion: 0.22
Nodes (8): ANALYSIS PROCESS, FRONTMATTER UPDATE, NEXT STEP, PRESENT FINDINGS, Red Flags, REFERENCE LOADING, Step 7: Check Comments, STEP GOAL

### Community 651 - "Community 651"
Cohesion: 0.22
Nodes (8): 1. Read Existing Report, 2. Show Progress Summary, 3. Offer Options, 4. Route to Next Step, EXECUTION, NEXT STEP, Step 1b: Continue Previous PR Review, STEP GOAL

### Community 652 - "Community 652"
Cohesion: 0.22
Nodes (8): ANALYSIS PROCESS, FRONTMATTER UPDATE, NEXT STEP, PRESENT FINDINGS, Questions to Answer, Step 3: Review the Code - High Level, STEP GOAL, What to Look At

### Community 653 - "Community 653"
Cohesion: 0.22
Nodes (8): 1. Read Existing Log, 2. Show Progress Summary, 3. Offer Options, 4. Route to Next Step, EXECUTION, NEXT STEP, Step 1b: Continue Previous Refactoring, STEP GOAL

### Community 654 - "Community 654"
Cohesion: 0.22
Nodes (8): Check, EXECUTION, FRONTMATTER UPDATE, If Tests Fail, NEXT STEP, PRESENT RESULTS, Step 5: Run Tests, STEP GOAL

### Community 655 - "Community 655"
Cohesion: 0.22
Nodes (8): Checklist, Commit the Change, EXECUTION, FRONTMATTER UPDATE, NEXT STEP, PRESENT RESULT, Step 6: Commit, STEP GOAL

### Community 656 - "Community 656"
Cohesion: 0.22
Nodes (8): Begin, Prerequisites, Refactoring Workflow, Rules, Step-File Architecture, Steps, The Golden Rule, When to Use

### Community 657 - "Community 657"
Cohesion: 0.22
Nodes (8): Boundary damping, Contents, Friction vs hard stops, Gesture and Drag Animations, Momentum-based dismissal, Multi-touch protection, Pointer capture, Swipe-to-dismiss pattern
...
Cohesion: 0.22
Nodes (8): 1. `src/server/modules/content/service.test.ts` (1 error), 2. `src/server/modules/swap/service.test.ts` (15 errors), Already fixed (10):, Concrete changes, Fix remaining typecheck errors, Remaining (16 errors in 2 files):, Status: 10/26 fixed, 16 remaining in 2 files, Verification
...
Cohesion: 0.25
Nodes (8): N1: Choose Descriptive Names, N2: Choose Names at the Appropriate Level of Abstraction, N3: Use Standard Nomenclature Where Possible, N4: Unambiguous Names, N5: Use Long Names for Long Scopes, N6: Avoid Encodings, N7: Names Should Describe Side-Effects, Names (N1-N7)

### Community 684 - "Community 684"
Cohesion: 0.25
Nodes (7): ANALYSIS PROCESS, FRONTMATTER UPDATE, NEXT STEP, PRESENT FINDINGS, REFERENCE LOADING, Step 8: Check for Smells, STEP GOAL

### Community 685 - "Community 685"
Cohesion: 0.25
Nodes (7): Begin, Code Review Workflow, Prerequisites, Rules, Step-File Architecture, Steps, When to Use

### Community 686 - "Community 686"
Cohesion: 0.25
Nodes (7): ANALYSIS PROCESS, Common Issues, FRONTMATTER UPDATE, NEXT STEP, PRESENT FINDINGS, Step 5: Check for Security Issues, STEP GOAL

### Community 687 - "Community 687"
Cohesion: 0.25
Nodes (7): ANALYSIS PROCESS, Common Issues, FRONTMATTER UPDATE, NEXT STEP, PRESENT FINDINGS, Step 6: Check for Performance Issues, STEP GOAL

### Community 688 - "Community 688"
Cohesion: 0.25
Nodes (7): Begin, PR Review Workflow, Prerequisites, Rules, Step-File Architecture, Steps, When to Use
...
Cohesion: 0.25
Nodes (7): Configuration presets, Interruptibility advantage, Snap instead of spring, Spring Animations, Spring-based mouse interactions, Spring parameters, When to use springs
...
Cohesion: 0.11
Nodes (18): otpStore, ApproveUserInput, approveUserSchema, LoginInput, loginSchema, RefreshInput, refreshSchema, RegisterInput (+10 more)
...
Cohesion: 0.13
Nodes (21): GET(), getSession(), GET(), createBulletinSchema, GET(), POST(), acknowledgeBulletin(), createBulletin() (+13 more)

### Community 709 - "Community 709"
Cohesion: 0.09
Nodes (27): CalendarConfig, HolidayImportResult, CalendarInsights, HolidayBridge, MonthShiftStats, CalendarEventEntry, CalendarHolidayEntry, CalendarOrgEventEntry (+19 more)
...
Cohesion: 0.11
Nodes (25): DynamicFormRenderer(), DynamicFormRendererProps, styles, FormReviewScreen(), styles, FormsInboxScreen(), styles, FormsScreen() (+17 more)

### Community 712 - "Community 712"
Cohesion: 0.09
Nodes (24): LessonPlayerView(), styles, CustomPageScreen(), ActionHistory, defaultHistory, defaultItems, EquipmentItem, EquipmentScreen() (+16 more)

### Community 713 - "Community 713"
Cohesion: 0.12
Nodes (16): سناریو ۱ — مسیر تازه‌وارد, سناریو ۲ — بازآموزی ایمنی سالانه (Compliance), سناریو ۳ — آزمون ضدتقلب نرم, سناریو ۴ — درس جلسه حضوری, سناریو ۵ — ادمین بدون‌کد دوره می‌سازد, 🎓 طرح جامع سامانه آموزش پرسنل (Training & Learning Platform), ۱) وضعیت موجود و زیرساخت قابل اتکا, ۱۰) ملاحظات فنی (+8 more)

### Community 714 - "Community 714"
Cohesion: 0.39
Nodes (6): assertPolicy(), CacheEntry, getStaticPolicyFallback(), invalidatePolicyCache(), policyCache, runDbPolicyCheck()

### Community 715 - "Community 715"
Cohesion: 0.24
Nodes (8): POST(), startExam(), submitExam(), awardPoints(), getLeaderboard(), GET(), POST(), submitSchema
...
Cohesion: 0.16
Nodes (18): ensurePersonnelCustomFields(), GET(), DEFAULT_FEATURES, DEFAULT_FOOTER_LINKS, DEFAULT_STATS, ensureLandingSettings(), getPublishedLandingData(), LANDING_SETTINGS_DEFAULTS (+10 more)

### Community 753 - "Community 753"
Cohesion: 0.25
Nodes (8): وضعیت فعلی طرح, پیشنهادهای توسعه حرفه‌ای, ۲) مدیریت حساب کاربری و احراز هویت, ۲.۱ احراز هویت سازمانی, ۲.۲ سطح‌بندی امنیت ورود, ۲.۳ مدیریت دستگاه‌ها, ۲.۴ چرخه عمر کاربر, ۲.۵ سیاست رمز عبور حرفه‌ای
...
Cohesion: 0.15
Nodes (21): AccessTokenPayload, getAccessSecret(), getRefreshSecret(), issueAccessToken(), issueRefreshToken(), RefreshTokenPayload, verifyRefreshToken(), POST() (+13 more)
...
Cohesion: 0.33
Nodes (6): C1: Inappropriate Information, C2: Obsolete Comment, C3: Redundant Comment, C4: Poorly Written Comment, C5: Commented-Out Code, Comments (C1-C5)

### Community 760 - "Community 760"
Cohesion: 0.33
Nodes (5): Contents, Contextual Animations, Contextual icon swaps, Subtle exit animations, Word-level stagger entrances
...
Cohesion: 0.04
Nodes (42): Certificate, ExamRecord, LearningPath, MyExamsPage(), PendingExam, EventLog, InfrastructurePage(), INITIAL_LOGS (+34 more)
...
Cohesion: 0.14
Nodes (25): toFa(), ensureNotificationPermission(), eventBaseTime(), syncReminders(), syncWidgetAndReminders(), COLORS, daysToNextOff(), findToday() (+17 more)
...
Cohesion: 0.29
Nodes (6): RosterUploadInput, rosterUploadSchema, SwapActionInput, swapActionSchema, SwapRequestInput, swapRequestSchema
...
Cohesion: 0.11
Nodes (14): LandingLightbox(), LandingLightboxProps, LightboxImage, OrbitImageData, OrbitImages(), OrbitImagesProps, CenterLogoProps, OrbitImageData (+6 more)

### Community 790 - "Community 790"
Cohesion: 0.24
Nodes (11): POST(), buildMyRosterDays(), buildSnapshot(), generateEtag(), MyRosterPayload, MyRosterTrip, precomputeOnPublish(), rebuildMyRosterDayForUsers() (+3 more)
...
Cohesion: 0.25
Nodes (8): وضعیت فعلی طرح, پیشنهادهای توسعه حرفه‌ای, ۴) پنل مدیریت حرفه‌ای, ۴.۱ داشبورد مدیریتی چندسطحی, ۴.۲ مرکز عملیات مدیریتی, ۴.۳ مدیریت دسترسی حرفه‌ای, ۴.۴ مدیریت تغییرات حساس, ۴.۵ Audit Log پیشرفته
...
Cohesion: 0.12
Nodes (13): POST(), verifyAccessToken(), GET(), POST(), POST(), POST(), GET(), POST() (+5 more)
...
Cohesion: 0.50
Nodes (3): RosterState, Shift, useRosterStore

### Community 821 - "Community 821"
Cohesion: 0.50
Nodes (3): SafetyBulletin, SafetyState, useSafetyStore

### Community 822 - "Community 822"
Cohesion: 0.50
Nodes (3): SwapRequest, SwapState, useSwapStore

### Community 823 - "Community 823"
Cohesion: 0.50
Nodes (4): config, isPublicPath(), middleware(), PUBLIC_API_PATHS

### Community 824 - "Community 824"
Cohesion: 0.25
Nodes (8): وضعیت فعلی طرح, پیشنهادهای توسعه حرفه‌ای, ۵) چت، پیام‌رسانی و روم‌های گفت‌وگو, ۵.۱ کانال‌های رسمی و غیررسمی, ۵.۲ پیام‌های رسمی با رسید قانونی, ۵.۳ اولویت‌بندی پیام, ۵.۴ قابلیت ضد ازدحام پیام, ۵.۵ حالت ارتباط اضطراری
...
Cohesion: 0.12
Nodes (17): cosineSimilarity(), EmbeddingPipeline, getEmbedding(), Article, CRITICAL_KEYWORDS, POST(), rankArticles(), RULEBOOK_DATABASE (+9 more)
...
Cohesion: 0.24
Nodes (7): RadioLog, RadioSimulatorScreen(), RadioChannel, RadioLog, RadioPhrase, RadioState, useRadioStore

### Community 833 - "Community 833"
Cohesion: 0.30
Nodes (12): exportMonthToExcel(), SHIFT_FA, WEEKDAY_FA, computeStats(), findBridges(), getCalendarInsights(), isRestDay(), monthDays() (+4 more)
...
Cohesion: 0.10
Nodes (27): DELETE(), POST(), schema, DELETE(), POST(), schema, deleteRadioChannel(), deleteRadioPhrase() (+19 more)
...
Cohesion: 0.18
Nodes (11): ۲) معماری مرجع مشترک (الگوهای تکرارشونده), ۲٫۱ الگوی سه‌گانهٔ هر ماژول, ۲٫۱۰ الزامات غیرکارکردی (NFR), ۲٫۲ الگوی «ماتریس دسترسی نقش» (RolePolicy), ۲٫۳ الگوی پیکربندی مبتنی بر `Setting`, ۲٫۴ الگوی استور SWR (Zustand), ۲٫۵ الگوی جهش خوش‌بینانه (Optimistic) + جلوگیری از تکرار, ۲٫۶ الگوی صفحه‌بندی Cursor (+3 more)

### Community 869 - "Community 869"
Cohesion: 0.43
Nodes (6): GET(), POST(), analyzeUserFatigue(), FatigueLogInput, fatigueLogSchema, submitFatigueLog()

### Community 870 - "Community 870"
Cohesion: 0.20
Nodes (10): استراتژی تست و QA, استراتژی مهاجرت و Seed, بخش ۶ — گالری ویدیوهای آموزشی, ترتیب اجرا و Milestoneها, تعریف «انجام‌شده» (Definition of Done), ریسک‌های کلان و پرسش‌های باز, فاز ۱۶ — واقعی‌سازی و سرعت گالری, فاز ۱۷ — پنل مدیریت گالری (`/admin/learning`) (+2 more)
...
Cohesion: 0.40
Nodes (4): طرح مهندسی توسعه‌یافته — بهینه‌سازی، پنل‌های مدیریتی بدون‌کد و گزارش‌گیری (۶ ماژول سیر و حرکت خط ۱), ۰) خلاصهٔ اجرایی, ۱) اصول راهبر (Guiding Principles), ۳) خلاصهٔ مدل دادهٔ جدید

### Community 875 - "Community 875"
Cohesion: 0.09
Nodes (25): MobileTripData, NextDepartureHeroMobile(), NextDepartureHeroMobileProps, styles, toPersianDigits(), MobileFilterState, SearchFilterBarMobile(), SearchFilterBarMobileProps (+17 more)

### Community 876 - "Community 876"
Cohesion: 0.40
Nodes (5): بخش ۱ — چت, فاز ۱ — سرعت فنی چت, فاز ۲ — پنل مدیریت چت (`/admin/chat`) بدون‌کد, فاز ۳ — گزارش‌گیری چت, وضعیت فعلی (خلاصه)
...
Cohesion: 0.40
Nodes (5): بخش ۲ — لوحهٔ اعزام روزانه, فاز ۴ — سرعت لوحه, فاز ۵ — پنل مدیریت لوحه (`/admin/roster`) بدون‌کد, فاز ۶ — گزارش‌گیری لوحه, وضعیت فعلی (خلاصه)

### Community 880 - "Community 880"
Cohesion: 0.25
Nodes (7): requestCategoryEnum, requestTypeConfigSchema, requestUnitEnum, ReviewRequestInput, reviewRequestSchema, SubmitRequestInput, submitRequestSchema

### Community 892 - "Community 892"
Cohesion: 0.60
Nodes (4): addPoints(), GamificationScoreData, getLeaderboard(), getUserScore()
...
Cohesion: 0.26
Nodes (8): GET(), CourseData, getCourseDetail(), getCourses(), updateEnrollmentProgress(), POST(), progressSchema, GET()
...
Cohesion: 0.40
Nodes (5): بخش ۳ — سامانهٔ بی‌سیم (comms/radio), فاز ۷ — واقعی‌سازی و سرعت رادیو, فاز ۸ — پنل مدیریت رادیو (`/admin/comms`), فاز ۹ — گزارش‌گیری رادیو, وضعیت فعلی (خلاصه)
...
Cohesion: 0.40
Nodes (5): بخش ۴ — دفتر تلفن هوشمند پرسنل, فاز ۱۰ — سرعت دفتر تلفن, فاز ۱۱ — پنل مدیریت دفتر تلفن (`/admin/directory`), فاز ۱۲ — گزارش‌گیری دفتر تلفن, وضعیت فعلی (خلاصه)

### Community 910 - "Community 910"
Cohesion: 0.25
Nodes (8): وضعیت فعلی طرح, پیشنهادهای توسعه حرفه‌ای, ۶) وبلاگ، اخبار، آموزش و مدیریت دانش, ۶.۱ تفکیک انواع محتوا, ۶.۲ چرخه انتشار محتوا, ۶.۳ محتوای اجباری, ۶.۴ موتور پیشنهاد محتوا, ۶.۵ Knowledge Base حرفه‌ای

### Community 911 - "Community 911"
Cohesion: 0.40
Nodes (5): بخش ۵ — اخبار و آموزش (content), فاز ۱۳ — سرعت محتوا, فاز ۱۴ — ارتقای پنل محتوا (`/admin/content`), فاز ۱۵ — گزارش‌گیری محتوا, وضعیت فعلی (خلاصه)

### Community 912 - "Community 912"
Cohesion: 0.09
Nodes (18): CalendarConfig, Holiday, HolidaysTab(), KIND_LABELS, OrgEvent, SeenReport, SHIFT_LABELS, ShiftHours (+10 more)
...
Cohesion: 0.24
Nodes (11): writeAuditLog(), createPersonalEvent(), deletePersonalEvent(), listPersonalEvents(), updatePersonalEvent(), GET(), POST(), DELETE() (+3 more)

### Community 925 - "Community 925"
Cohesion: 0.25
Nodes (8): وضعیت فعلی طرح, پیشنهادهای توسعه حرفه‌ای, ۷) گالری تصویر و فیلم آموزشی, ۷.۱ مسیر یادگیری, ۷.۲ پیشرفت آموزشی, ۷.۳ آزمون حرفه‌ای‌تر, ۷.۴ کنترل مصرف دیتا, ۷.۵ گواهی دیجیتال
...
Cohesion: 0.10
Nodes (20): سناریو ۱ — الحاقیه و «آخرین نسخه» (قاتل داده منسوخ), سناریو ۲ — بخشنامههای جایگزینشونده (دردِ روزمره مترو), سناریو ۳ — پرسش کلی (Global), سناریو ۴ — صف ادغام هویت, سناریو ۵ — «یافت نشد» صادقانه, سناریو ۶ — اسکن قدیمی, 🧠 طرح نهایی: موتور دانش گرافی دستیار AI (Hybrid GraphRAG), کوئری نمونه — «آخرین تعهد معتبر» (+12 more)

### Community 928 - "Community 928"
Cohesion: 0.25
Nodes (8): وضعیت فعلی طرح, پیشنهادهای توسعه حرفه‌ای, ۸) لوحه، شیفت و استخراج هوشمند, ۸.۱ موتور پردازش لوحه, ۸.۲ انتشار مرحله‌ای لوحه, ۸.۳ تقویم شیفت حرفه‌ای, ۸.۴ درخواست جابه‌جایی شیفت, ۸.۵ Rule Engine برای شیفت
...
Cohesion: 0.25
Nodes (8): وضعیت فعلی طرح, پیشنهادهای توسعه حرفه‌ای, ۹) نوتیفیکیشن و مرکز اعلان, ۹.۱ مرکز اعلان چندسطحی, ۹.۲ سیاست اعلان, ۹.۳ ارسال هدفمند, ۹.۴ زمان‌بندی هوشمند, ۹.۵ گزارش اثربخشی اعلان

### Community 1026 - "Community 1026"
Cohesion: 0.25
Nodes (8): وضعیت فعلی طرح, پیشنهادهای توسعه حرفه‌ای, ۳) پروفایل شخصی و دفتر تلفن هوشمند, ۳.۱ پروفایل عملیاتی پرسنل, ۳.۲ کارت پرسنلی دیجیتال, ۳.۳ دفتر تلفن هوشمند عملیاتی, ۳.۴ حریم خصوصی سطح‌بندی‌شده, ۳.۵ خروجی اضطراری دفتر تلفن
...
Cohesion: 0.29
Nodes (6): s, SHIFT_LABELS, ShiftOption, SwapRequest, SwapScreen(), UserOption
...
Cohesion: 0.33
Nodes (5): ChecklistItem, checklistItemSchema, CreateChecklistTemplate, SubmitChecklistRecord, submitChecklistRecordSchema

### Community 1156 - "Community 1156"
Cohesion: 0.11
Nodes (18): Commands you will need, Current state, Done criteria, Git workflow, Maintenance notes, Plan 002: Stop leaking the OTP in the API response, use a CSPRNG, and rate-limit auth endpoints, Scope, Status (+10 more)

### Community 1157 - "Community 1157"
Cohesion: 0.33
Nodes (5): CreateAppealInput, CreatePerformanceLogInput, createPerformanceLogSchema, ReviewAppealInput, reviewAppealSchema
...
Cohesion: 0.11
Nodes (18): Commands you will need, Current state, Done criteria, Git workflow, Maintenance notes, Plan 005: Fix three runtime crashes / logic bugs (roster null-sort, layout null-body, swap shift-interval), Scope, Status (+10 more)
...
Cohesion: 0.12
Nodes (21): extractRequestContext(), RequestContext, WriteAuditLogParams, getOrCreateIcsToken(), rotateIcsToken(), logSchema, LEVEL_SEVERITY, logDebug() (+13 more)
...
Cohesion: 0.19
Nodes (16): POST(), CreateBulletinInput, CreateTicketInput, createTicketSchema, UpdateTicketStatusInput, updateTicketStatusSchema, withErrorLogging(), POST() (+8 more)
...
Cohesion: 0.16
Nodes (17): buildCompositeKey(), GroupKey, GROUPS_LIST, normalizeGroup(), parseTargetId(), SHIFT_TYPE_LIST, ShiftRegime, shiftTypeKey (+9 more)

### Community 1209 - "Community 1209"
Cohesion: 0.11
Nodes (17): Commands you will need, Current state, Done criteria, Git workflow, Maintenance notes, Plan 001: Remove unauthenticated dev endpoints and the config-file data dump, Scope, Status (+9 more)

### Community 1210 - "Community 1210"
Cohesion: 0.11
Nodes (17): Commands you will need, Current state, Done criteria, Git workflow, Maintenance notes, Plan 003: Fix the settings service hot path (per-read re-seed), dedupe default keys, and add characterization tests, Scope, Status (+9 more)

### Community 1211 - "Community 1211"
Cohesion: 0.11
Nodes (17): Commands you will need, Current state, Done criteria, Git workflow, Maintenance notes, Plan 004: Restrict CORS, add security headers, and sanitize database-sourced HTML, Scope, Status (+9 more)

### Community 1212 - "Community 1212"
Cohesion: 0.12
Nodes (16): Commands you will need, Current state, Done criteria, Git workflow, Maintenance notes, Plan 006: Stop exposing AI provider API keys and raw error messages to clients, Scope, Status (+8 more)

### Community 1213 - "Community 1213"
Cohesion: 0.17
Nodes (13): CtaTab(), FEATURE_ICONS, FeatureItem, FooterLinkItem, HeroQuote, ImagesTab(), LandingCta, OrbitImage (+5 more)

### Community 1214 - "Community 1214"
Cohesion: 0.13
Nodes (14): FaultReport, PRIORITY_LABELS, STATUS_LABELS, ACTION_LABELS, AdminFaultDashboard(), FaultDetail, FaultLog, KANBAN_COLUMNS (+6 more)
...
Cohesion: 0.20
Nodes (9): CreateCommentInput, CreatePostInput, createPostSchema, postStatuses, postTypes, TransitionPostStatusInput, transitionPostStatusSchema, UpdatePostInput (+1 more)

### Community 1219 - "Community 1219"
Cohesion: 0.33
Nodes (6): checkRateLimit(), resetRateLimits(), WindowEntry, windows, POST(), sendOtpSchema

### Community 1220 - "Community 1220"
Cohesion: 0.22
Nodes (8): Backlog — vetted findings not yet planned, Dependency notes, Direction — options for the maintainer (not ranked against bugs), Execution order & status, Findings considered and rejected, Implementation Plans, Verification baseline (read before executing any plan), What was NOT audited
...
Cohesion: 0.29
Nodes (6): content, escapedContent, fs, mdPath, outPath, path

### Community 1224 - "Community 1224"
Cohesion: 0.12
Nodes (15): Announcement, AnnouncementLibrary(), AnnouncementLibraryProps, defaultAnnouncements, BroadcastEntry, BroadcastHistory(), BroadcastHistoryProps, defaultEntries (+7 more)

### Community 1225 - "Community 1225"
Cohesion: 0.33
Nodes (5): fileChanges, fs, lines, log, logRaw
...
Cohesion: 0.14
Nodes (16): getCalendarConfig(), audienceIncludes(), CalendarDay, CalendarMeetingEntry, CalendarShiftEntry, DEFAULT_LAYERS, getFallbackHours(), HARDCODED_FALLBACK (+8 more)
...
Cohesion: 0.17
Nodes (14): ChatMessage, Env, WebSocketSession, DurableObjectNamespace, DurableObjectStub, R2Bucket, WebSocketPair, getStorage() (+6 more)
...
Cohesion: 0.15
Nodes (12): fetchPrivateConfig(), apiFetch(), fetcher(), clientLogDebug(), clientLogError(), clientLogInfo(), clientLogWarn(), logToServer() (+4 more)

### Community 1250 - "Community 1250"
Cohesion: 0.15
Nodes (16): $type, $value, xl, $type, $value, $type, $value, radius (+8 more)

### Community 1251 - "Community 1251"
Cohesion: 0.29
Nodes (6): CustomFieldDefInput, customFieldDefUpdateSchema, UserImportRow, userImportRowSchema, UserSearchParams, userSearchSchema
...
## Knowledge Gaps
- **10202 isolated node(s):** `$schema`, `$value`, `$type`, `$value`, `$type` (+10197 more)
...
- **Why does `cachedFetch()` connect `Community 875` to `Community 832`, `Community 1249`, `Community 711`, `Community 778`, `Community 187`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `getSessionUser()` connect `Community 26` to `API Routes & RBAC`, `Tooling Configuration`, `Auth & Bulletin Routes`, `Community 527`, `Community 529`, `Community 19`, `Community 790`, `Community 410`, `Community 924`, `Community 28`, `Community 546`, `Community 803`, `Community 804`, `Community 45`, `Community 558`, `Community 562`, `Community 1202`, `Community 1205`, `Community 53`, `Community 826`, `Community 59`, `Community 705`, `Community 708`, `Community 709`, `Community 326`, `Community 715`, `Community 852`, `Community 219`, `Community 220`, `Community 869`, `Community 755`, `Community 372`, `Community 895`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `authErrorResponse()` connect `Tooling Configuration` to `API Routes & RBAC`, `Auth & Bulletin Routes`, `Community 527`, `Community 529`, `Community 19`, `Community 790`, `Community 26`, `Community 410`, `Community 924`, `Community 28`, `Community 546`, `Community 803`, `Community 45`, `Community 558`, `Community 562`, `Community 1202`, `Community 1205`, `Community 53`, `Community 826`, `Community 59`, `Community 705`, `Community 708`, `Community 709`, `Community 326`, `Community 715`, `Community 852`, `Community 219`, `Community 220`, `Community 869`, `Community 372`, `Community 895`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Are the 240 inferred relationships involving `getSessionUser()` (e.g. with `GET()` and `POST()`) actually correct?**
  _`getSessionUser()` has 240 INFERRED edges - model-reasoned connections that need verification._
- **Are the 224 inferred relationships involving `authErrorResponse()` (e.g. with `GET()` and `POST()`) actually correct?**
  _`authErrorResponse()` has 224 INFERRED edges - model-reasoned connections that need verification._
- **Are the 74 inferred relationships involving `requireRole()` (e.g. with `GET()` and `PATCH()`) actually correct?**
  _`requireRole()` has 74 INFERRED edges - model-reasoned connections that need verification._
- **Are the 7 inferred relationships involving `cn()` (e.g. with `AdminAIPage()` and `HealthCard()`) actually correct?**
