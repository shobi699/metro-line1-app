# Graph Report - metro-line1-app  (2026-07-08)

## Corpus Check
- 1636 files · ~2,694,835 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 16246 nodes · 22075 edges · 1198 communities (996 shown, 202 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 664 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2a020c53`
...
1. `getSessionUser()` - 606 edges
2. `authErrorResponse()` - 599 edges
3. `prisma` - 225 edges
4. `requireRole()` - 220 edges
5. `cn()` - 184 edges
6. `toFa()` - 146 edges
7. `useAuthStore` - 142 edges
8. `requirePermission()` - 142 edges
9. `Button()` - 93 edges
10. `Card()` - 78 edges
...
## Communities (1198 total, 202 thin omitted)

### Community 0 - "API Routes & RBAC"
Cohesion: 0.06
Nodes (48): configUpdateSchema, authenticateRequest(), formatCalDate(), ALL_PERMISSIONS, hasPermission(), Permission, PERMISSION_CATALOG, PermissionGroup (+40 more)

### Community 1 - "Service Layer & Validation"
Cohesion: 0.11
Nodes (30): findAssignmentForUser(), getShiftForUserAndDate(), getShiftForUserAndDateFromDb(), MOCK_USERS_LIST, GROUPS_LIST, DbShift, ResolvedShiftResponse, ShiftAssignmentDto (+22 more)

### Community 3 - "UI Components & Layout"
Cohesion: 0.06
Nodes (39): metadata, RootLayout(), CATEGORIES, CustomFieldDef, DirectoryPage(), ImportResult, UserRow, Badge (+31 more)

### Community 4 - "Pages & Client State"
Cohesion: 0.07
Nodes (32): AppContent(), HomeStackScreen(), RootStackParamList, Stack, Tab, FormField, FormTemplate, SubmitRequestScreen() (+24 more)
...
Cohesion: 0.02
Nodes (203): DELETE(), GET(), chunkText(), indexKnowledgeSource(), aiProviderSchema, GET(), POST(), GET() (+195 more)
...
Cohesion: 0.07
Nodes (46): acknowledgeMessage(), assertMember(), changeRoomSettings(), createGroupRoom(), getOrCreateDirectRoom(), getRoomReactions(), getRoomSettings(), listMessages() (+38 more)
...
Cohesion: 0.04
Nodes (111): CacheRecord, emptyForm, Provider, AuditLogRow, AttendanceRecord, Device, INITIAL_DEVICES, ChecklistItem (+103 more)
...
Cohesion: 0.17
Nodes (17): AccessTokenPayload, getAccessSecret(), getRefreshSecret(), issueAccessToken(), issueRefreshToken(), RefreshTokenPayload, verifyAccessToken(), verifyRefreshToken() (+9 more)
...
Cohesion: 0.06
Nodes (53): ackSchema, POST(), GET(), GET(), addComment(), createPost(), deletePost(), emptyToNull() (+45 more)
...
Cohesion: 0.09
Nodes (32): CalendarConfig, createHoliday(), createOrgEvent(), DEFAULT_CALENDAR_CONFIG, deleteHoliday(), deleteOrgEvent(), HolidayImportResult, listHolidays() (+24 more)
...
Cohesion: 0.04
Nodes (72): approveInputSchema, GET(), POST(), createCustomFieldDef(), deleteCustomFieldDef(), ensurePersonnelCustomFields(), getCustomFieldDef(), listCustomFieldDefs() (+64 more)
...
Cohesion: 0.02
Nodes (100): AICachePage(), AIProvidersPage(), TripData, AppLayout(), AttendancePage(), useAuthStore, BiometricsPage(), AdminBulletinsPage() (+92 more)
...
Cohesion: 0.09
Nodes (28): buildCompositeKey(), GroupKey, normalizeGroup(), parseTargetId(), SHIFT_TYPE_LIST, ShiftRegime, shiftTypeKey, targetIdLabel() (+20 more)
...
Cohesion: 0.08
Nodes (35): POST(), GET(), querySchema, GET(), fuzzyMatchScore(), levenshteinDistance(), normalizeFarsiString(), GET() (+27 more)
...
Cohesion: 0.04
Nodes (54): PostCard, TYPE_FILTERS, DashboardPage(), FaultLog, FaultReport, LOG_ACTION_LABELS, PRIORITY_CLASSES, PRIORITY_LABELS (+46 more)

### Community 62 - "Community 62"
Cohesion: 0.03
Nodes (76): cn(), AuditLog, AVAILABILITY_LABELS, DEFAULT_THEME_COLORS, FullProfile, PLATE_LETTERS, ProfilePage(), ROLE_LABEL (+68 more)
...
Cohesion: 0.08
Nodes (10): KvAdapter, MemoryAdapter, OtpAdapter, OtpEntry, otpStore, ResetEntry, KvNamespace, resetPasswordSchema (+2 more)
...
Cohesion: 0.11
Nodes (32): MonthlyReportScreen(), AttendanceRecord, AttendanceScreen(), METRO_STATIONS, MetroStation, ChatScreen(), ChecklistsScreen(), s (+24 more)

### Community 135 - "Community 135"
Cohesion: 0.11
Nodes (14): AIAssistantScreen(), CITATION_DATABASE, FAQ_ITEMS, Message, Poll, PollOption, PollsScreen(), Survey (+6 more)
...
Cohesion: 0.06
Nodes (71): FAQ, Interaction, KnowledgeSource, layers, Persona, Provider, ReportData, Bulletin (+63 more)
...
Cohesion: 0.05
Nodes (48): cosineSimilarity(), EmbeddingPipeline, getEmbedding(), Article, CRITICAL_KEYWORDS, POST(), rankArticles(), RULEBOOK_DATABASE (+40 more)
...
Cohesion: 0.06
Nodes (39): POST(), GET(), POST(), authenticate(), GET(), POST(), calculatePeriodScoresAndNormalize(), COMPETENCY_IDS (+31 more)
...
Cohesion: 0.03
Nodes (101): POST(), PATCH(), PATCH(), GET(), ChangedTrip, computeDiff(), driverForRole(), RosterDiff (+93 more)
...
Cohesion: 0.07
Nodes (48): calendarApi, exportMonthToExcel(), SHIFT_FA, WEEKDAY_FA, CalendarPage(), CalendarState, monthRange(), useCalendarStore (+40 more)
...
Cohesion: 0.11
Nodes (13): ACTION_LABELS, AuditActor, AuditLogEntry, AuditLogsPage(), ENTITY_LABELS, AuthState, SessionUser, PrivateConfig (+5 more)
...
Cohesion: 0.25
Nodes (9): DurableObjectStub, R2Bucket, WebSocketPair, StorageDriver, StoredFile, localStorageDriver, UPLOAD_ROOT, createR2Driver() (+1 more)
...
Cohesion: 0.22
Nodes (7): Certificate, ExamRecord, LearningPath, LearningScreen(), PendingExam, SAMPLE_QUESTIONS, VideoItem
...
Cohesion: 0.05
Nodes (34): ActiveTrain, AnalyticsData, DashboardStats, MetroStation, OperationLog, RecentBulletin, SCADASubsystem, STATION_POSITIONS (+26 more)
...
Cohesion: 0.16
Nodes (19): GET(), audienceIncludes(), CalendarEventEntry, CalendarHolidayEntry, CalendarOrgEventEntry, DEFAULT_LAYERS, FALLBACK_HOURS, getCalendarRange() (+11 more)
...
Cohesion: 0.15
Nodes (14): ApproveUserInput, LoginInput, loginSchema, RefreshInput, refreshSchema, RegisterInput, registerSchema, ResetPasswordInput (+6 more)
...
Cohesion: 0.14
Nodes (13): ApproveUserInput, LoginInput, loginSchema, RefreshInput, refreshSchema, RegisterInput, registerSchema, ResetPasswordInput (+5 more)
...
Cohesion: 0.16
Nodes (17): commitCatalogImport(), commitFaultReportsImport(), commitTrainsImport(), ExcelImportError, ExcelImportPreview, exportToExcel(), parseDate(), parseExcelBoolean() (+9 more)
...
Cohesion: 0.27
Nodes (10): CalendarInsights, computeStats(), findBridges(), getCalendarInsights(), HolidayBridge, isRestDay(), monthDays(), MonthShiftStats (+2 more)
...
Cohesion: 0.14
Nodes (13): RosterDay, RosterScreen(), toPersianDigits(), Trip, TripAssignment, cachedFetch(), OfflineBanner(), styles (+5 more)
...
Cohesion: 0.15
Nodes (10): fetchPrivateConfig(), apiFetch(), ChatMessage, ChatRoom, Env, WebSocketSession, DurableObjectNamespace, DurableObjectState (+2 more)
...
## Knowledge Gaps
- **9813 isolated node(s):** `$schema`, `$value`, `$type`, `$value`, `$type` (+9808 more)
...
- **Why does `cachedFetch()` connect `Community 875` to `Community 880`, `Community 778`, `Community 187`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `getFieldDefs()` connect `Community 880` to `UI Components & Layout`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `prisma` connect `Community 28` to `Community 640`, `API Routes & RBAC`, `Tooling Configuration`, `Auth & Bulletin Routes`, `Community 14`, `Community 527`, `Community 17`, `Community 529`, `Community 19`, `Community 532`, `Community 789`, `Community 26`, `Community 410`, `Community 924`, `Community 802`, `Community 803`, `Community 558`, `Community 562`, `Community 53`, `Community 826`, `Community 59`, `Community 61`, `Community 705`, `Community 66`, `Community 326`, `Community 852`, `Community 214`, `Community 219`, `Community 220`, `Community 869`, `Community 492`, `Community 372`, `Community 892`, `Community 895`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Are the 188 inferred relationships involving `getSessionUser()` (e.g. with `GET()` and `POST()`) actually correct?**
  _`getSessionUser()` has 188 INFERRED edges - model-reasoned connections that need verification._
- **Are the 185 inferred relationships involving `authErrorResponse()` (e.g. with `GET()` and `POST()`) actually correct?**
  _`authErrorResponse()` has 185 INFERRED edges - model-reasoned connections that need verification._
- **Are the 66 inferred relationships involving `requireRole()` (e.g. with `GET()` and `PATCH()`) actually correct?**
  _`requireRole()` has 66 INFERRED edges - model-reasoned connections that need verification._
