...
## Corpus Check
- 1310 files · ~2,220,044 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 14204 nodes · 17379 edges · 1143 communities (902 shown, 241 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 239 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9d575513`
...
- `TestTailwindConfigGenerator` --uses--> `TailwindConfigGenerator`  [INFERRED]
  .agents/.agents/skills/ckm-ui-styling/scripts/tests/test_tailwind_config_gen.py → .agents/skills/ckm-ui-styling/scripts/tailwind_config_gen.py
...
## Communities (1143 total, 241 thin omitted)

### Community 0 - "API Routes & RBAC"
Cohesion: 0.03
Nodes (89): GET(), GET(), POST(), getNonReaders(), GET(), PATCH(), POST(), activateCrisis() (+81 more)

### Community 1 - "Service Layer & Validation"
Cohesion: 0.07
Nodes (50): findAssignmentForUser(), getShiftForUserAndDate(), getShiftForUserAndDateFromDb(), MOCK_USERS_LIST, buildCompositeKey(), GroupKey, groupKeyFor(), GROUPS_LIST (+42 more)
...
Cohesion: 0.07
Nodes (51): AttendanceData, checkIn(), checkOut(), getTodayAttendance(), getUserAttendance(), POST(), GET(), POST() (+43 more)
...
Cohesion: 0.09
Nodes (32): HomeStackScreen(), AIAssistantScreen(), Message, Bulletin, BulletinsScreen(), CabinModeScreen(), getStyles(), Trip (+24 more)
...
Cohesion: 0.13
Nodes (20): MainTabs(), RootStackParamList, Stack, Tab, CustomPageScreen(), DashboardStats, HomeScreen(), TodayShift (+12 more)

### Community 12 - "Registration Flow"
Cohesion: 0.03
Nodes (135): AuditLogRow, AttendancePage(), AttendanceRecord, Device, INITIAL_DEVICES, ChecklistItem, ChecklistRecord, LINE1_STATIONS (+127 more)
...
Cohesion: 0.07
Nodes (40): approveInputSchema, RosterUploadInput, rosterUploadSchema, SwapActionInput, swapActionSchema, SwapRequestInput, swapRequestSchema, GET() (+32 more)
...
Cohesion: 0.09
Nodes (36): AccessTokenPayload, getAccessSecret(), getRefreshSecret(), issueAccessToken(), issueRefreshToken(), RefreshTokenPayload, verifyAccessToken(), verifyRefreshToken() (+28 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (57): AdminBulletinsPage(), Bulletin, CHANNEL_KIND_META, ChatView(), PRIORITY_META, UserOption, addMessage(), ChannelKind (+49 more)
...
Cohesion: 0.11
Nodes (17): package, projectId, expo, android, extra, ios, name, orientation (+9 more)
...
Cohesion: 0.06
Nodes (43): fromJalali(), gregStr(), jdate(), gd_g(), gd_j(), isLeapGregorian(), jalaliToGregorianArray(), persianDigits (+35 more)
...
Cohesion: 0.27
Nodes (10): exportUsersToExcel(), generateErrorReport(), ImportError, ImportResult, importUsersFromExcel(), PaginatedUsers, userImportRowSchema, toEn() (+2 more)
...
Cohesion: 0.04
Nodes (63): TripData, ACTION_LABELS, AuditActor, AuditLogEntry, AuditLogsPage(), ENTITY_LABELS, AuthState, SessionUser (+55 more)
...
Cohesion: 0.10
Nodes (19): fetchPrivateConfig(), ChatMessage, ChatRoom, Env, WebSocketSession, DurableObjectNamespace, DurableObjectState, DurableObjectStub (+11 more)
...
Cohesion: 0.03
Nodes (78): POST(), CRITICAL_KEYWORDS, POST(), RULEBOOK_DATABASE, RulebookItem, KvAdapter, MemoryAdapter, OtpAdapter (+70 more)
...
Cohesion: 0.03
Nodes (87): DocumentRequest, INITIAL_REQUESTS, cn(), FaultTicketCard(), FaultTicketCardProps, priorityConfig, IranPlate(), IranPlateProps (+79 more)
...
Cohesion: 0.05
Nodes (19): Tests for tailwind_config_gen.py, Test adding custom spacing., Test TailwindConfigGenerator class., Test initialization with default settings., Test plugin recommendations., Test generating JavaScript configuration., Test generating config with plugins., Test validating valid configuration. (+11 more)

### Community 66 - "Community 66"
Cohesion: 0.05
Nodes (63): POST(), POST(), GET(), querySchema, GET(), fuzzyMatchScore(), jalaliToDate(), levenshteinDistance() (+55 more)
...
Cohesion: 0.09
Nodes (18): ActiveTrain, AnalyticsData, DashboardStats, MetroStation, OperationLog, RecentBulletin, SCADASubsystem, STATION_POSITIONS (+10 more)
...
Cohesion: 0.13
Nodes (16): ChecklistItem, ChecklistRecord, ChecklistsScreen(), LINE1_STATIONS, Template, DirectoryScreen(), DirectoryUser, BASE_URL (+8 more)
...
Cohesion: 0.11
Nodes (26): CalendarScreen(), JALALI_MONTHS, SHIFT_MAPPING, Bulletin, BulletinGuard(), styles, calculateShiftForDate(), getShiftForUserAndDate() (+18 more)
...
Cohesion: 0.14
Nodes (19): POST(), GET(), POST(), GET(), POST(), calculatePeriodScoresAndNormalize(), COMPETENCY_IDS, filePerformanceAppeal() (+11 more)

### Community 219 - "Community 219"
Cohesion: 0.18
Nodes (9): Participant, VoiceConferenceScreen(), VoiceRoom, cycleColors, darkTheme, defaultTheme, Theme, ThemeContext (+1 more)
...
Cohesion: 0.12
Nodes (16): AppContent(), AttendanceRecord, AttendanceScreen(), METRO_STATIONS, MetroStation, NEXT_LABEL, NEXT_STATUS, PRIORITY_COLORS (+8 more)
...
Cohesion: 0.09
Nodes (23): GET(), POST(), createCustomFieldDef(), deleteCustomFieldDef(), ensurePersonnelCustomFields(), getCustomFieldDef(), listCustomFieldDefs(), updateCustomFieldDef() (+15 more)
...
## Knowledge Gaps
- **8828 isolated node(s):** `$schema`, `$value`, `$type`, `$value`, `$type` (+8823 more)
...
- **Why does `cachedFetch()` connect `Community 35` to `Community 134`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `getFieldDefs()` connect `Community 35` to `Community 62`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `prisma` connect `Community 14` to `API Routes & RBAC`, `Service Layer & Validation`, `Pages & Client State`, `Auth & Bulletin Routes`, `Community 527`, `Community 17`, `Community 529`, `Community 19`, `Community 410`, `Community 28`, `Community 33`, `Community 558`, `Community 562`, `Community 53`, `Community 59`, `Community 705`, `Community 66`, `Community 326`, `Community 218`, `Community 220`?**
