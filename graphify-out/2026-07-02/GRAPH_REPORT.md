...
## Corpus Check
- 1313 files · ~2,459,641 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 14233 nodes · 17481 edges · 1147 communities (906 shown, 241 thin omitted)
...
## Communities (1147 total, 241 thin omitted)
...
Cohesion: 0.07
Nodes (34): AppContent(), HomeStackScreen(), RootStackParamList, Stack, Tab, AIAssistantScreen(), Message, Bulletin (+26 more)
...
Cohesion: 0.13
Nodes (19): MainTabs(), DEFAULT_MENU_ITEMS, DEFAULT_SYSTEM_SETTINGS, DEFAULT_WIDGETS, UIBuilderScreen(), CustomTabBar(), cycleColors, darkTheme (+11 more)

### Community 12 - "Registration Flow"
Cohesion: 0.03
Nodes (144): AuditLogRow, AttendancePage(), AttendanceRecord, Device, INITIAL_DEVICES, ChecklistItem, ChecklistRecord, LINE1_STATIONS (+136 more)
...
Cohesion: 0.04
Nodes (54): TripData, ACTION_LABELS, AuditActor, AuditLogEntry, AuditLogsPage(), ENTITY_LABELS, AuthState, SessionUser (+46 more)
...
Cohesion: 0.12
Nodes (25): AttendanceScreen(), ChecklistsScreen(), DirectoryScreen(), DirectoryUser, DashboardStats, HomeScreen(), TodayShift, NEXT_LABEL (+17 more)
...
Cohesion: 0.11
Nodes (14): AttendanceRecord, METRO_STATIONS, MetroStation, ChecklistItem, ChecklistRecord, LINE1_STATIONS, Template, NavGroup (+6 more)
...
Cohesion: 0.36
Nodes (5): CustomPageScreen(), ComponentSchema, DynamicRenderer(), DynamicRendererProps, handleDynamicNavigation()
...
Cohesion: 0.36
Nodes (7): ChatScreen(), SOSScreen(), ScreenWrapper(), ChatMessage, ChatRoom, ChatState, useChatStore
...
## Knowledge Gaps
- **8845 isolated node(s):** `$schema`, `$value`, `$type`, `$value`, `$type` (+8840 more)
...
- **Why does `getFieldDefs()` connect `Tooling Configuration` to `Community 62`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `toFa()` connect `Community 33` to `Community 640`, `Community 321`, `Service Layer & Validation`, `Community 35`, `UI Components & Layout`, `Registration Flow`, `Community 18`, `Community 26`, `Community 62`?**
