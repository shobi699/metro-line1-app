# Graph Report - metro-line1-app  (2026-07-05)

## Corpus Check
- 1458 files · ~2,542,937 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 14831 nodes · 19558 edges · 1132 communities (889 shown, 243 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 449 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b67e846a`
...
1. `getSessionUser()` - 443 edges
2. `authErrorResponse()` - 436 edges
3. `prisma` - 182 edges
4. `cn()` - 179 edges
5. `requireRole()` - 157 edges
6. `useAuthStore` - 131 edges
7. `toFa()` - 126 edges
...
## Communities (1132 total, 243 thin omitted)

### Community 0 - "API Routes & RBAC"
Cohesion: 0.03
Nodes (158): POST(), DELETE(), GET(), aiProviderSchema, GET(), POST(), GET(), GET() (+150 more)

### Community 1 - "Service Layer & Validation"
Cohesion: 0.14
Nodes (24): DbShift, ResolvedShiftResponse, ShiftAssignmentDto, ShiftNoteDto, ShiftTaskDto, ShiftTemplateDto, CycleShiftDetail, CycleTemplate (+16 more)

### Community 3 - "UI Components & Layout"
Cohesion: 0.08
Nodes (28): AppLayout(), metadata, RootLayout(), Badge, BulletinGuard, Button, Card, Dialog (+20 more)

### Community 4 - "Pages & Client State"
Cohesion: 0.06
Nodes (45): HomeStackScreen(), MainTabs(), RootStackParamList, Stack, Tab, MonthlyReportScreen(), SubmitRequestScreen(), AIAssistantScreen() (+37 more)
...
Cohesion: 0.08
Nodes (32): GET(), GET(), hasPermission(), GET(), POST(), POST(), PATCH(), DELETE() (+24 more)
...
Cohesion: 0.09
Nodes (22): DashboardStats, TodayShift, LoginScreen(), DEFAULT_MENU_ITEMS, DEFAULT_SYSTEM_SETTINGS, DEFAULT_WIDGETS, BASE_URL, setApiUrl() (+14 more)

### Community 12 - "Registration Flow"
Cohesion: 0.03
Nodes (67): BiometricsPage(), Device, INITIAL_DEVICES, DOCS_DATA, DocSection, Certificate, ExamRecord, LearningPath (+59 more)

### Community 13 - "Swap Request Actions"
Cohesion: 0.05
Nodes (43): dependencies, dayjs, expo, expo-blur, expo-document-picker, expo-file-system, expo-font, @expo-google-fonts/vazirmatn (+35 more)

### Community 14 - "Community 14"
Cohesion: 0.11
Nodes (26): approveInputSchema, POST(), POST(), GET(), POST(), POST(), POST(), GET() (+18 more)
...
Cohesion: 0.08
Nodes (32): POST(), createFormSubmission(), evaluateFormula(), executeWorkflowAction(), validateSubmissionData(), GET(), POST(), GET() (+24 more)

### Community 18 - "Community 18"
Cohesion: 0.07
Nodes (29): PrivateConfig, usePrivateConfig(), CHANNEL_KIND_META, ChatView(), PRIORITY_META, UserOption, addMessage(), ChannelKind (+21 more)

### Community 19 - "Community 19"
Cohesion: 0.07
Nodes (44): GET(), addComment(), createPost(), deletePost(), emptyToNull(), extractPrerequisiteId(), getPostBySlug(), listComments() (+36 more)
...
Cohesion: 0.06
Nodes (37): ChecklistItem, ChecklistRecord, ChecklistsPage(), LINE1_STATIONS, SAMPLE_HISTORY, SAMPLE_TEMPLATES, Template, buildCompositeKey() (+29 more)
...
Cohesion: 0.07
Nodes (43): GET(), POST(), createCustomFieldDef(), deleteCustomFieldDef(), ensurePersonnelCustomFields(), getCustomFieldDef(), listCustomFieldDefs(), updateCustomFieldDef() (+35 more)
...
Cohesion: 0.03
Nodes (72): AICachePage(), AIProvidersPage(), TripData, AttendancePage(), AttendanceRecord, ACTION_LABELS, AuditActor, AuditLogEntry (+64 more)
...
Cohesion: 0.09
Nodes (21): OCCPage(), SosAlert, Ticket, FaultTicketCard(), FaultTicketCardProps, priorityConfig, defaultStations, LiveTrackMap() (+13 more)
...
Cohesion: 0.03
Nodes (91): KvAdapter, MemoryAdapter, OtpAdapter, OtpEntry, otpStore, ResetEntry, approveUserSchema, registerSchema (+83 more)
...
Cohesion: 0.04
Nodes (57): PostCard, TYPE_FILTERS, CrisisEvent, CrisisPage(), INCIDENT_TYPES, IncidentReport, SAMPLE_SOS_ALERTS, SOS_STATUS_LABELS (+49 more)

### Community 62 - "Community 62"
Cohesion: 0.02
Nodes (98): QuickAddType, ActiveTrain, AnalyticsData, DashboardStats, MetroStation, OperationLog, RecentBulletin, SCADASubsystem (+90 more)
...
Cohesion: 0.04
Nodes (61): POST(), GET(), querySchema, feedbackSchema, GET(), fuzzyMatchScore(), levenshteinDistance(), normalizeFarsiString() (+53 more)
...
Cohesion: 0.10
Nodes (25): CabinModeScreen(), getStyles(), Trip, ChatScreen(), ManagerUser, MEETING_ROOMS, MeetingRequest, MeetingsScreen() (+17 more)

### Community 135 - "Community 135"
Cohesion: 0.05
Nodes (94): CacheRecord, emptyForm, Provider, AuditLogRow, Bulletin, AdminContentPageContent(), AdminPost, EditorBlock (+86 more)
...
Cohesion: 0.09
Nodes (31): d1, d2, CalendarScreen(), JALALI_MONTHS, SHIFT_MAPPING, LeaveReportScreen(), calculateShiftForDate(), getShiftForUserAndDate() (+23 more)
...
Cohesion: 0.14
Nodes (23): audienceIncludes(), CalendarDay, CalendarEventEntry, CalendarHolidayEntry, CalendarOrgEventEntry, CalendarShiftEntry, DEFAULT_LAYERS, getCalendarRange() (+15 more)
...
Cohesion: 0.12
Nodes (17): ActiveModal, PLATE_LETTERS, ProfileScreen(), ROLE_LABEL, { width: SCREEN_W, height: SCREEN_H }, FaultReport, LOG_ACTION_LABELS, PRIORITY_COLORS (+9 more)
...
Cohesion: 0.05
Nodes (44): getAdapter(), cosineSimilarity(), EmbeddingPipeline, getEmbedding(), AIGateway, Article, CRITICAL_KEYWORDS, POST() (+36 more)
...
Cohesion: 0.33
Nodes (8): GET(), createFeedback(), FeedbackData, getFeedbackStats(), listFeedback(), replyToFeedback(), PATCH(), POST()
...
Cohesion: 0.06
Nodes (51): calendarApi, CalendarPage(), CalendarState, monthRange(), useCalendarStore, CalendarDay, CalendarEventEntry, CalendarHolidayEntry (+43 more)
...
Cohesion: 0.09
Nodes (32): Certificate, ExamRecord, LearningPath, LearningScreen(), PendingExam, SAMPLE_QUESTIONS, VideoItem, toFa() (+24 more)
...
Cohesion: 0.27
Nodes (9): findAssignmentForUser(), getShiftForUserAndDate(), getShiftForUserAndDateFromDb(), MOCK_USERS_LIST, groupKeyFor(), calculateShiftForDate(), findAssignment(), resolveShiftForUser() (+1 more)
...
Cohesion: 0.06
Nodes (37): POST(), GET(), POST(), authenticate(), GET(), POST(), calculatePeriodScoresAndNormalize(), COMPETENCY_IDS (+29 more)
...
Cohesion: 0.13
Nodes (18): AppContent(), AttendanceRecord, AttendanceScreen(), METRO_STATIONS, MetroStation, ChecklistsScreen(), s, DirectoryScreen() (+10 more)
...
Cohesion: 0.29
Nodes (6): RosterDay, RosterScreen(), toPersianDigits(), Trip, TripAssignment, cachedFetch()
...
Cohesion: 0.19
Nodes (13): extractRequestContext(), RequestContext, writeAuditLog(), WriteAuditLogParams, createPersonalEvent(), deletePersonalEvent(), listPersonalEvents(), updatePersonalEvent() (+5 more)
...
## Knowledge Gaps
- **9009 isolated node(s):** `$schema`, `$value`, `$type`, `$value`, `$type` (+9004 more)
...
- **Why does `cachedFetch()` connect `Community 875` to `Community 752`, `Community 803`, `Community 410`, `Session & Auth Store`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `prisma` connect `Community 66` to `API Routes & RBAC`, `Community 640`, `Community 772`, `Tooling Configuration`, `Auth & Bulletin Routes`, `Community 779`, `Community 781`, `Community 14`, `Community 527`, `Community 17`, `Community 529`, `Community 19`, `Community 28`, `Community 924`, `Community 558`, `Community 562`, `Community 53`, `Community 569`, `Community 59`, `Community 61`, `Community 321`, `Community 705`, `Community 854`, `Community 219`, `Community 220`, `Community 221`, `Community 755`, `Community 372`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `getFieldDefs()` connect `Community 803` to `Community 62`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Are the 122 inferred relationships involving `getSessionUser()` (e.g. with `GET()` and `POST()`) actually correct?**
  _`getSessionUser()` has 122 INFERRED edges - model-reasoned connections that need verification._
- **Are the 119 inferred relationships involving `authErrorResponse()` (e.g. with `GET()` and `POST()`) actually correct?**
  _`authErrorResponse()` has 119 INFERRED edges - model-reasoned connections that need verification._
...
- **Are the 49 inferred relationships involving `requireRole()` (e.g. with `GET()` and `POST()`) actually correct?**
