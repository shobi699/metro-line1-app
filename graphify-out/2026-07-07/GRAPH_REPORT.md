...
## Corpus Check
- 1610 files · ~2,664,789 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 16063 nodes · 21599 edges · 1181 communities (980 shown, 201 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 585 edges (avg confidence: 0.8)
...
## Communities (1181 total, 201 thin omitted)
...
Cohesion: 0.14
Nodes (25): DbShift, ResolvedShiftResponse, ShiftAssignmentDto, ShiftNoteDto, ShiftTaskDto, ShiftTemplateDto, CycleShiftDetail, CycleTemplate (+17 more)

### Community 3 - "UI Components & Layout"
Cohesion: 0.11
Nodes (20): metadata, RootLayout(), Badge, BulletinGuard, Button, Card, Dialog, toFa/jalali (+12 more)

### Community 4 - "Pages & Client State"
Cohesion: 0.07
Nodes (34): HomeStackScreen(), MainTabs(), RootStackParamList, Stack, Tab, GUIDE_ITEMS, GuideItem, GuideScreen() (+26 more)
...
Cohesion: 0.04
Nodes (115): AuditLogRow, AttendanceRecord, Device, INITIAL_DEVICES, Bulletin, ChecklistItem, ChecklistRecord, ChecklistsPage() (+107 more)
...
Cohesion: 0.04
Nodes (64): approveInputSchema, GET(), RosterUploadInput, rosterUploadSchema, SwapActionInput, swapActionSchema, SwapRequestInput, swapRequestSchema (+56 more)
...
Cohesion: 0.07
Nodes (43): AccessTokenPayload, getAccessSecret(), getRefreshSecret(), issueAccessToken(), issueRefreshToken(), RefreshTokenPayload, verifyAccessToken(), verifyRefreshToken() (+35 more)

### Community 18 - "Community 18"
Cohesion: 0.08
Nodes (25): PrivateConfig, usePrivateConfig(), CHANNEL_KIND_META, ChatView(), PRIORITY_META, UserOption, addMessage(), ChannelKind (+17 more)
...
Cohesion: 0.10
Nodes (24): buildCompositeKey(), normalizeGroup(), parseTargetId(), targetIdLabel(), Shift, SHIFT_COLORS, SHIFT_LABELS, ShiftCalendar() (+16 more)
...
Cohesion: 0.06
Nodes (29): GET(), POST(), createCustomFieldDef(), deleteCustomFieldDef(), ensurePersonnelCustomFields(), getCustomFieldDef(), listCustomFieldDefs(), updateCustomFieldDef() (+21 more)
...
Cohesion: 0.03
Nodes (93): AICachePage(), AIProvidersPage(), TripData, AppLayout(), AttendancePage(), ACTION_LABELS, AuditActor, AuditLogEntry (+85 more)
...
Cohesion: 0.05
Nodes (32): ActiveTrain, AnalyticsData, DashboardStats, MetroStation, OperationLog, RecentBulletin, SCADASubsystem, STATION_POSITIONS (+24 more)
...
Cohesion: 0.03
Nodes (92): POST(), KvAdapter, MemoryAdapter, OtpAdapter, OtpEntry, otpStore, ResetEntry, approveUserSchema (+84 more)
...
Cohesion: 0.04
Nodes (62): PostCard, TYPE_FILTERS, DashboardPage(), FeedbackPage(), FaultLog, FaultReport, LOG_ACTION_LABELS, PRIORITY_CLASSES (+54 more)

### Community 62 - "Community 62"
Cohesion: 0.03
Nodes (84): CATEGORIES, CustomFieldDef, DirectoryPage(), ImportResult, UserRow, cn(), Announcement, AnnouncementLibrary() (+76 more)
...
Cohesion: 0.05
Nodes (70): POST(), GET(), querySchema, GET(), fuzzyMatchScore(), jalaliToDate(), levenshteinDistance(), normalizeFarsiString() (+62 more)
...
Cohesion: 0.07
Nodes (50): MonthlyReportScreen(), FormField, FormTemplate, SubmitRequestScreen(), AIAssistantScreen(), CITATION_DATABASE, FAQ_ITEMS, Message (+42 more)
...
Cohesion: 0.03
Nodes (164): DELETE(), GET(), aiProviderSchema, GET(), POST(), GET(), GET(), PATCH() (+156 more)
...
Cohesion: 0.06
Nodes (74): CacheRecord, FAQ, Interaction, KnowledgeSource, layers, Persona, Provider, ReportData (+66 more)
...
Cohesion: 0.12
Nodes (15): LoginScreen(), ActiveModal, PLATE_LETTERS, ProfileScreen(), ROLE_LABEL, { width: SCREEN_W, height: SCREEN_H }, BASE_URL, setApiUrl() (+7 more)
...
Cohesion: 0.06
Nodes (41): POST(), GET(), POST(), authenticate(), jalaliPeriodId(), GET(), POST(), calculatePeriodScoresAndNormalize() (+33 more)
...
Cohesion: 0.05
Nodes (66): chunkText(), indexKnowledgeSource(), POST(), getPostAckStats(), GET(), updatePlaylistSchema, updateScreenSchema, aiKnowledgeSourceSchema (+58 more)
...
Cohesion: 0.15
Nodes (18): createFeedbackSchema, GET(), addFeedbackMessage(), createFeedback(), FeedbackData, getFeedbackCategories(), getFeedbackDetail(), getFeedbackStats() (+10 more)
...
Cohesion: 0.12
Nodes (25): cachedFetch(), ensureNotificationPermission(), eventBaseTime(), syncReminders(), syncWidgetAndReminders(), COLORS, daysToNextOff(), findToday() (+17 more)
...
Cohesion: 0.14
Nodes (17): audienceIncludes(), DEFAULT_LAYERS, FALLBACK_HOURS, OrgAudience, resolveHolidayLayer(), resolveOrgLayer(), resolvePersonalLayer(), resolveShiftLayer() (+9 more)
...
Cohesion: 0.14
Nodes (23): exportMonthToExcel(), SHIFT_FA, WEEKDAY_FA, CalendarInsights, computeStats(), findBridges(), getCalendarInsights(), HolidayBridge (+15 more)
...
Cohesion: 0.09
Nodes (28): AppContent(), AttendanceRecord, AttendanceScreen(), METRO_STATIONS, MetroStation, ChecklistsScreen(), s, DirectoryScreen() (+20 more)
...
Cohesion: 0.07
Nodes (27): GeminiAdapter, adapters, AIProviderAdapter, AIResponse, getAdapter(), ProviderConfig, OpenAICompatibleAdapter, AIGateway (+19 more)
...
## Knowledge Gaps
- **9742 isolated node(s):** `$schema`, `$value`, `$type`, `$value`, `$type` (+9737 more)
...
- **Why does `cachedFetch()` connect `Community 778` to `Community 875`, `Session & Auth Store`, `Community 880`, `Community 187`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `prisma` connect `Community 28` to `Service Layer & Validation`, `Community 1157`, `Tooling Configuration`, `Community 776`, `Auth & Bulletin Routes`, `Community 14`, `Community 527`, `Community 912`, `Community 17`, `Community 529`, `Community 19`, `Community 532`, `Community 789`, `Community 410`, `Community 924`, `Community 803`, `Community 558`, `Community 562`, `Community 53`, `Community 826`, `Community 59`, `Community 61`, `Community 832`, `Community 705`, `Community 66`, `Community 852`, `Community 219`, `Community 220`, `Community 492`, `Community 880`, `Community 755`, `Community 372`, `Community 895`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `getFieldDefs()` connect `Community 880` to `Community 62`?**
